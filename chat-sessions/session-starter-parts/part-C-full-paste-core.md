...
【今やってる主タスク（2026-08-16 反映・2026-08-16 WAKE同期）】
- 本日レーン: 夜セッション。次アプリは浜田指示。手順正本 `docs/runbooks/kintone-existing-app-ux-improve-v1.md`。**694/696/715 再開しない**。
- checkpoint: 2026-08-16 10:39 JST — Cursor JS/TS 除外後、朝セッション再締め。
