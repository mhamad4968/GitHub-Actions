...
> **L2 フォールバック（2026-06-21）**: 通常入口は **`docs/runbooks/session-lifecycle-v2.md`** + **`npm run cio:session:cold-start`**。本ハブ 6 部全文 Read は **`bootstrap exit ≠ 0`** 時のみ（Lifecycle v2 §3 L2）。
