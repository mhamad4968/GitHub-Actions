...
**2026-04-29（浜田 CIO）**: セッション切替のたびに AI は **`npm run session:clock:set` を必ず実行**し、続けて **`npm run session:clock:web`** でターミナルに出た **URL を浜田へ促してブラウザで開く**（`AGENTS.md` §51-6 遵守事項 5、`NEW-SESSION-STARTER` 項番 4）。
