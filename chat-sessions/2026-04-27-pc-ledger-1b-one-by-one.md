...
1a. **モデル（朝イチで決め済み）**: `checkpoint-latest.md` **朝イチ5つ** 項番 1〜2 + `AGENTS.md` **§1-2・§1-2-3-2**。正本の深読・矛盾解消・**Tier B 直前**は **L3（Opus 4.7 Max Thinking）**、質疑準備・文書整合は **L2 以上**を推奨。タスク冒頭は **§1-2-3-1** のティア宣言 1 行。  
...
| ~~2~~ | ~~§11.I の 626/667 表記~~ | §11.I | **解消**（深読で正本修正: 新採番マスタを正・旧626/667は5/13以降閲覧のみ。§4.2.0・§4.2.2 logon 行・§5.2 jbs→sjm・§10.2 日付整合も反映） |
