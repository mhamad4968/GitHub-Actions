# 復元チェックポイント（最新）
**最終更新**: 2026-09-13 08:45 JST — 756 金額増減 LIVE rev370。目視待ち。
**次の1手**: 浜田が **2版**の総括・内訳で金額増減列を目視（第1版は列なし）。予実 G0 は **実装GO待ち**。正本 `docs/plans/2026-09-12-jikkou-yosan-v2-cost-mgmt-g0.md`。
**レーン変更**: 共有PC後日／756追加customize待ち → **756 予実 G0（工種単位）実装**
**Git**: **`09613077`** = `origin/main` — push 済
**closeStatus**: **partial**
...
**本日状態**: **756**=`2026-09-13-ver02-amount-delta` rev**370** fileKey `e1a200a8-dd3f-49a0-a071-5cd360aaba9f`。**757**=`2026-07-21-ver02-phase6-app2-readonly-guard` rev**34**（unit に泊）。**715**=`2026-09-10-715-vl-serial-continue` rev**28**。749=`2026-08-29-749-ux-toolbar-copy-pill-print` rev**18**。696=`2026-08-24-696-modal-keep-open` rev**18**。682=`2026-08-23-682-banner-label-clarify` rev**30**。683=`2026-09-02-683-wiring-print-box` rev**117**。721=`2026-08-23-jr-ipad-dash-p2-vux` rev**17**
**674 live fileKey**: `a16f2595-8e7c-44b2-8bec-98e329aca6c3`
### 本日アクティブ（BUILD/rev — 2026-09-13）
| App | BUILD | rev |
|-----|-------|-----|
| **756** | `2026-09-13-ver02-amount-delta` | **370** |
...
**GO待ち**: 予実の **実装GO**。一時保存は一般ユーザ目視OK（2026-09-13）。内訳 Tab 目視OK。金額増減は **2版の目視待ち**。夜§13.1は1–7決。日終わり⑦ after-go
...
| **736** | 現行版保持・触らない |
| **756/757/758** | 756 LIVE rev370 金額増減 · 757 rev34 · 758 rev31 · everyone 書込。単位DD 20項。**一時保存 一般ユーザ目視OK**。洞0。757 customize 未deploy |
| **712** | 削除済 — deploy 禁止 |
