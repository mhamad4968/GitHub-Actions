...
**最終更新**: 2026-04-27 (Mon) 夜 — **22:00 まで詰める方針**（1 ターン 1 問・同一晩複数回可）。浜田確定: **メールは個人用 PC のみ**／共有・JR は **共有 PC 扱いで Windows + M365 のみ** → 正本 **§4.2.0 / §4.2.2 / §4.5 / §C** と `windows_name` 共有列 `=logon_name`、指紋更新。**前回**: §4.5 mail UI 非表示明記・v3.17・1b。
