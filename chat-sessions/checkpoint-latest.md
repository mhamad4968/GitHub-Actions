...
**最終更新**: 2026-04-27 (Mon) — **仕様確認＝1b オーダー完走**: フェーズ **1b-A〜C**（Read + `field-spec:generate` 35 + テンプレ）／曖昧な「確認しますか？」禁止／`NEW-SESSION-STARTER` **v3.16**。**前回**: 仕様書 Read 必須・v3.15・`session-handoff`・正本主義・RULES-INDEX。
