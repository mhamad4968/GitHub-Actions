...
**最終更新**: 2026-04-26 (Sun) 夜 — **時刻は `date -Is`（JST）**／**19:15 JST 以降**に仕様は **1 ターン 1 問**（それ以前は質問しない・`2026-04-27-pc-ledger-1b-one-by-one.md` にキュー）。正本精読に伴い **§10.1 L2 整合**・**§11.H 5/13**・**採番テストの新マスタ表記**を修正。**前回**: メール個人のみ・Windows+M365・22:00 方針。
