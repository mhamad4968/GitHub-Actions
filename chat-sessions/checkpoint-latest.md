...
**レーン変更**: 日終わり完了
**Git**: **`2784184b`** = `origin/main` — push 済（close-git で再同期）
...
### 本日アクティブ（BUILD/rev — 2026-09-09）
| App | BUILD | rev |
|-----|-------|-----|
| **756** | `2026-09-09-ver02-ascii-num-ime` | **361** |
...
**GO待ち**: なし（③全GO済）。756は9/10レビュー後の新依頼。数値IMEは今夜完了
...
| **736** | 現行版保持・触らない |
| **756/757/758** | 756 LIVE rev361 · 757 rev31 · 757 customize 未deploy |
| **712** | 削除済 — deploy 禁止 |
