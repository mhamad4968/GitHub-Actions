# 復元チェックポイント（最新）
**最終更新**: 2026-08-05 19:30 JST — **回答待ち**。8/7に共有フォルダー＋ADグループ事前準備（手順書あり）。orphan除外・ターゲット123。
**次の1手**: **SKY社回答待ち**／浜田は **8/7** に `docs/runbooks/skysea-2026-08-07-folder-ad-prep.md` どおり準備。
**Git**: docs 更新後 commit+push
**本日状態（要約）**: 問い合わせ送信済。dry-run済。orphan除外。実配信禁止維持。
