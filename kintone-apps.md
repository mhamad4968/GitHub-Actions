...
| 新・PC台帳ver.1（本体 / Day 4 雛形→Day 5 本実装・**構築中・運用開始前**） | **674** | `customize/new-pc-ledger-v1/desktop.js` | `npm run deploy:674` / Space **21** / thread **23** / **live revision 34**（2026-04-29 JST・PC 編集で `record.get()` null 対策 + 利用者名 `getFieldElement` PC 優先・v0.7.2）/ customize **BUILD=`2026-04-29-day5-autogen-v0.7.2`** / fileKey **`1c7834df-6d38-4f52-ae3c-f163fc178a98`** / field-spec **44/44**（Day4 手順書）/ **運用開始予定 2026-05-13**（仕様書 §1） |
