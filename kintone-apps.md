...
| 756 | `2026-07-25-ver02-font-scale` | **91** | `9ab46599-ee6e-4262-8dc9-ca2562ab2555` | Ver.02 App1 fail-closed read-only shell |
...
| **実行予算書作成支援ツールver02**（App1・read-only shell） | **756** | `customize/jikkou-yosan-v2-app1/desktop.js` | [https://jbis-kintone.cybozu.com/k/756/](https://jbis-kintone.cybozu.com/k/756/) **Space 56 / thread 60**・3アプリ版メインUI・ACLは fail-closed read-only。**BUILD=`2026-07-25-ver02-font-scale` rev **91** / fileKey **`9ab46599-ee6e-4262-8dc9-ca2562ab2555`** |
