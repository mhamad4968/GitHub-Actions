...
|-----|---------------|----------|---------|------|
| 595 | `2026-06-30-595-bulk-log-no-dup` | **106** | `6f18e8d8-1f43-4902-8aca-6e2f2298c114` | 2026-06-30 一括反映ログを697へ・システム行削除 |
...
| 社員マスタ（674/714/716 連携） | **595** | `customize/595/desktop.js` | **本番 live 最終 deploy（2026-06-30）**: `npm run deploy:595` **SUCCESS** / fileKey **`6f18e8d8-1f43-4902-8aca-6e2f2298c114`** / preview revision **`104`** / **BUILD=`2026-06-30-595-bulk-log-via-697`**（一括反映ログは **697 共通設定** `bulk_downstream_595_log` に保存・595 にシステム用社員行は出さない）。**前 deploy**: rev **103** / **BUILD=`2026-06-30-595-bulk-log-no-dup` rev ** 106 **** |
