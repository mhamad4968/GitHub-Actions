...
| **部署予実・ダッシュ**（**集計管理の主画面**・俯瞰・入力アプリ参照） | **678** | `customize/678/desktop.js` \| `npm run deploy:678` | [https://jbis-kintone.cybozu.com/k/678/](https://jbis-kintone.cybozu.com/k/678/)・入力と同スペース。**2026-04-29** 枠のみ deploy **SUCCESS**。**2026-05-02**: 677 明細表・備考・`display_order` PUT・API 失敗メッセージ deploy **SUCCESS** / fileKey **`5f992f52-5148-4b10-b7fb-e018ff0bf8bf`** / rev **7**。**2026-05-03**（§10.1）: リンク集・運用メモ・利用注意・費用種別フィルタ・`$revision` / fileKey **`0e77462b-36e9-4406-8cc9-25ceb0581fdc`** / rev **8** / **BUILD=`2026-05-03-678-dashboard-milestone`**。**続**: **新フォーマット準拠グリッド**（左キー10列＋12月×四つ柱・`monthly_breakdown` API・sticky・帯色）・**BUILD=`2026-05-03-678-dashboard-excel-grid`** / rev **9**。**2026-05-04**: **一覧マウント強化** / **BUILD=`2026-05-04-678-mount-host`** / rev **10** / fileKey **`58627781-d292-4f74-82d4-d0c215fca5e9`**。**続**: **読み込みガード** / **BUILD=`2026-05-04-678-load-guard`** / rev **11** / fileKey **`9f8fba50-5a75-44a5-88a4-133728d7b1f3`**。**修正**: **`kintone.api.url` 呼び出し**（`.get`/`.put` は非存在 → `url(path,true)` 形式）・**BUILD=`2026-05-04-678-api-url-fix`** / rev **12** / fileKey **`6b091321-1f08-4b46-994c-7b7c8b0ad2bb`**。`SPEC.md` §6b・§6e |
