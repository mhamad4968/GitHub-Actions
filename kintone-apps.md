...
| 715 | `2026-06-14-software-ledger-dash-sw-info-label` | **6** | `69ab1b99-1170-4577-86d1-04c11d5b9a80` | 2026-06-14 ソフトウエアの情報ラベル |
...
| 721 | `2026-06-15-jr-ipad-dash-v1` | **4** | `eb524a26-7be2-4fd4-a982-74b18b788ec3` | 2026-06-15 JR iPad 台帳 v1 |
...
| **ソフトウエア管理台帳ver.1**（日常 UI・714 へ REST） | **715** | `customize/software-ledger-dash/desktop.js` \| `npm run deploy:715` | [https://jbis-kintone.cybozu.com/k/715/](https://jbis-kintone.cybozu.com/k/715/) **Space 21 / thread 23**・**2026-06-14**: 595 連携・識別3スロット・リスト印刷・**BUILD=`2026-06-14-software-ledger-dash-sw-info-label`** rev **6** |
...
| **JRシステム用iPad管理台帳 ver.1**（日常 UI・720 へ REST） | **721** | `customize/jr-ipad-dash/desktop.js` \| `npm run deploy:721` | [https://jbis-kintone.cybozu.com/k/721/](https://jbis-kintone.cybozu.com/k/721/) **Space 34 / thread 38**・**2026-06-15**: 694 型一覧・2 系統採番・部署×ステータス集計・A4 印刷・**BUILD=`2026-06-15-jr-ipad-dash-v1`** rev **4** |
...
| JRシステム用iPad管理台帳 ver.1 | **721** | `customize/jr-ipad-dash/desktop.js`（`desktop.src.js` + bundle） | `2026-06-15-jr-ipad-dash-v1` rev4 | `deploy:721`（前に `jr-ipad:bundle-dash`） |

**721 主要機能**: 694 型一覧・admin のみ・2 系統採番（JBIS### + jb###m）・22 部署×5 ステータス集計・端末別 A4 印刷・モデルコンボボックス + NFKC 正規化。

**状態（2026-06-15）**: **実装完了 — 浜田目視待ち**。Excel **64 台移行済**。
