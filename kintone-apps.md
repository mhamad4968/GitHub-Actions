...
| 694 | `2026-06-03-apple-id-dash-no-toolbar-new` | **13** | `5d77ad24-e9c4-4f6e-84cd-6e1432731cad` | 2026-06-03 ツールバー新規採番削除 |
...
| **Apple ID管理台帳**（日常 UI・693 へ REST） | **694** | `customize/apple-id-dash/desktop.js` \| `npm run deploy:694` | [https://jbis-kintone.cybozu.com/k/694/](https://jbis-kintone.cybozu.com/k/694/) **Space 21 / thread 23**・**2026-06-03**: 一覧・フィルタ・検索・**新規採番**（**jbis.039 未割当プール起点**）・編集・廃止・削除・印刷・**BUILD=`2026-06-03-apple-id-dash-next-slot-banner`** |
