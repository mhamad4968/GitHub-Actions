...
| 756 | `2026-07-26-ver02-addon5-construction-menu` | **145** | `7ddca217-2cdb-46c7-b17b-b77a3145176e` | Ver.02 App1 fail-closed read-only shell |
| 757 | `2026-07-21-ver02-phase6-app2-readonly-guard` | **26** | `f8f9a413-8c14-4750-8563-3f290dfe8fed` | Ver.02 App2 direct-write guard / fail-closed read-only shell |
| 758 | `2026-07-21-ver02-phase6-app3-readonly-guard` | **25** | `dca32378-488f-4453-a1cf-ce50597b1aa1` | Ver.02 App3 direct-write guard / fail-closed read-only shell |
