...
| **メールアドレス管理台帳**（日常 UI・695 へ REST） | **696** | `customize/shared-mail-dash/desktop.js` \| `npm run deploy:696` | [https://jbis-kintone.cybozu.com/k/696/](https://jbis-kintone.cybozu.com/k/696/) **Space 21 / thread 23**・接続設定パネル・新規 PW **`sjb`+乱数4桁+`1M#`**・印刷・**BUILD=`2026-06-21-696-mail-address-ledger-title`** rev **10**（2026-06-21 アプリ名変更） |
