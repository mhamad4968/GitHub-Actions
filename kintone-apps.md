...
| 694 | `2026-08-11-694-print-user-name` | **20** | `32f9b309-6d0e-4aae-bec8-9d6d092e10c5` | 2026-06-08 端末交換日フィールド |
...
| **Apple ID管理台帳**（日常 UI・693 へ REST） | **694** | `customize/apple-id-dash/desktop.js` \| `npm run deploy:694` | [https://jbis-kintone.cybozu.com/k/694/](https://jbis-kintone.cybozu.com/k/694/) **Space 21 / thread 23**・**2026-06-06**: 編集で **Apple ID・PW・ロック** 修正可・**BUILD=`2026-08-11-694-print-user-name` rev **20** / fileKey **`32f9b309-6d0e-4aae-bec8-9d6d092e10c5`** |
