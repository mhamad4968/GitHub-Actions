...
|-----|---------------|----------|---------|------|
| 595 | `2026-06-23-595-dept-master-sort-no` | **98** | `6ae0fe9e-1ccd-4627-bd91-d5b0bd7b9cc0` | 2026-06-19 680所属候補モーダル |
...
| 750 | `2026-06-29-mailing-list-db-block-ui` | **6** | `e3b52456-0f28-433f-afb2-fc6894ba2fb7` | 2026-06-29 メーリングリスト DB save/delete ブロック |
| 751 | `2026-06-29-mailing-list-dash-v1` | **4** | — | 2026-06-29 メーリングリスト台帳 v1（deploy 待ち） |
...
| **メーリングリストDB**（正本・閲覧のみ） | **750** | `customize/mailing-list-db/desktop.js` \| `npm run deploy:750` | [https://jbis-kintone.cybozu.com/k/750/](https://jbis-kintone.cybozu.com/k/750/) **Space 48 / thread 52**・**v1 運用開始** — 11 フィールド・**63 件移行済**・正本 `docs/plans/2026-06-29-mailing-list-kintone-spec.md`・**BUILD=`2026-06-29-mailing-list-db-block-ui` rev **6**** rev **5** |
| **メーリングリスト台帳**（日常 UI・750 へ REST） | **751** | `customize/mailing-list-dash/desktop.js` \| `npm run deploy:751` | [https://jbis-kintone.cybozu.com/k/751/](https://jbis-kintone.cybozu.com/k/751/) **Space 48 / thread 52**・696/749 型一覧・メンバー検索・変更メモ・印刷/xlsx・**BUILD=`2026-06-29-mailing-list-dash-v1` rev **4**** |
