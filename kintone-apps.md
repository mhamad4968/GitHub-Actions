...
| 688 | `2026-06-24-688-print-a4-fit-v6` | **73** | `f0fce5ee-b07d-4213-8e88-e45d8a9043d3` | 2026-06-24 A4横・塗装/足場/休日1枚収め |
| 735 | — | — | — | 2026-06-18 実行予算書リストマスタ（104件 seed・customize なし） |
| 736 | `2026-06-23-jikkou-yosan-diff-structural-match` | **123** | `86380bc7-14e0-4257-9b06-30802b996a06` | 2026-06-23 v2c 画面差分（直前版自動比較・構造キー突合） |
...
| **工事稼働日数ダッシュ（日常入口）** | **688** | `customize/688/desktop.js` \| `npm run deploy:688` | [https://jbis-kintone.cybozu.com/k/688/](https://jbis-kintone.cybozu.com/k/688/) **Space 56**・687 REST。**BUILD=`2026-06-24-688-print-a4-fit-v6`** rev **73** / fileKey **`f0fce5ee-b07d-4213-8e88-e45d8a9043d3`**（施工主報告 **A4横・デフォルト余白で左見切れ解消**・**塗装/足場/休日を各1枚に収める**・過去5年 **降雨/風速別枚**。**`cio:preflight:688` → `deploy:688`**）。仕様 **`docs/plans/2026-06-13-construction-workdays-excel-20260613.md`** §9–§10 |
...
| **実行予算書作成支援ツール　ver.01** | **736** | `customize/736/desktop.js` \| `npm run deploy:736` | [https://jbis-kintone.cybozu.com/k/736/](https://jbis-kintone.cybozu.com/k/736/) **Space 56 / thread 60**・735 REST・688型一覧+Excel風フォーム・**合計行 薄茶色**（①⑧⑨・塗料/その他合計・外注「合計」・**注文金額**・**法定福利費（合計）**）・**諸経費・労務費明細は灰色**・**総括表印刷** ⑧⑨ **最終ページのみ**・**v2c 画面差分**（版2以降は直前版と自動比較・直接編集/自動反映分離・削除行折りたたみ）。**BUILD=`2026-06-23-jikkou-yosan-diff-structural-match`** rev **123** / fileKey **`86380bc7-14e0-4257-9b06-30802b996a06`**。版管理仕様 **`docs/plans/2026-06-20-jikkou-yosan-version-management-spec.md`**・親仕様 **`docs/plans/2026-06-18-jikkou-yosan-spec.md`** §9 |
...
|-------------|----------|----------------|
| 2026-06-24T10:28:08Z | 688 | `customize/688/desktop.js` |
