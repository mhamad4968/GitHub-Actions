...
| 770 | `2026-07-28-tokai-ipad-dash-v2-pc-status-resolve` | **7** | `b93d2e43-0b8d-48cb-9e7d-a45ca35783a5` | 2026-07-28 東海支店iPad Dash v1（一覧・採番・印刷・Excel・同期） |
...
| **東海支店iPad管理台帳**（日常 UI・769 へ REST） | **770** | `customize/tokai-ipad-dash/desktop.js` \| `npm run deploy:770` | [https://jbis-kintone.cybozu.com/k/770/](https://jbis-kintone.cybozu.com/k/770/) **Space 32 / thread 34**・**BUILD=`2026-07-28-tokai-ipad-dash-v2-pc-status-resolve` rev **7** / fileKey **`b93d2e43-0b8d-48cb-9e7d-a45ca35783a5`**・ACL=tokai+admin・Lookup なし・595/674 は admin 直／tokai は同期中継（`docs/runbooks/tokai-ipad-sync-relay.md`） |
