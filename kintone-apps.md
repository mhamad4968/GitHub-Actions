...
| 688 | `2026-06-24-688-print-a4-popup-v7` | **75** | `f0fce5ee-b07d-4213-8e88-e45d8a9043d3` | 2026-06-24 A4横・塗装/足場/休日1枚収め |
...
| **工事稼働日数ダッシュ（日常入口）** | **688** | `customize/688/desktop.js` \| `npm run deploy:688` | [https://jbis-kintone.cybozu.com/k/688/](https://jbis-kintone.cybozu.com/k/688/) **Space 56**・687 REST。**BUILD=`2026-06-24-688-print-a4-popup-v7`** rev **75** / fileKey **`ac9809be-3f92-4c14-872f-22c574c27f03`**（施工主報告 **専用ウィンドウでA4横印刷**・**塗装/足場/休日各1枚**・過去5年 **降雨/風速別枚**。**`cio:preflight:688` → `deploy:688`**）。仕様 **`docs/plans/2026-06-13-construction-workdays-excel-20260613.md`** §9–§10 |
