...
|-----|---------------|----------|---------|------|
| 595 | `2026-07-01-595-index-clear-q-param` | **111** | `6e7ed3af-07b3-4802-b2cf-061b12a5968b` | 2026-07-01 退職674連携revision修正・一覧q=クリア |
...
| 社員マスタ（674/714/716 連携） | **595** | `customize/595/desktop.js` | **本番 live 最終 deploy（2026-07-01）**: `npm run deploy:595` **SUCCESS** / fileKey **`6e7ed3af-07b3-4802-b2cf-061b12a5968b`** / preview revision **`111`** / **BUILD=`2026-07-01-595-index-clear-q-param`**（退職→674連携で `$revision` 読取修正・674アカウント全クリア・一覧「条件クリア」で URL `q=` も解除）。**前 deploy**: rev **110** / **BUILD=`2026-07-01-595-account-clear-all`** |
...
| **メーリングリストDB**（正本・閲覧のみ） | **750** | `customize/mailing-list-db/desktop.js` \| `npm run deploy:750` | [https://jbis-kintone.cybozu.com/k/750/](https://jbis-kintone.cybozu.com/k/750/) **Space 48 / thread 52**・**v1 完成 — CLOSED** — 11 フィールド・**63 件移行済**・正本 `docs/plans/2026-06-29-mailing-list-kintone-spec.md`・本番 Excel **削除済**（2026-06-29）・**BUILD=`2026-06-29-mailing-list-db-block-ui`** rev **6** |
| **メーリングリスト台帳**（日常 UI・750 へ REST） | **751** | `customize/mailing-list-dash/desktop.js` \| `npm run deploy:751` | [https://jbis-kintone.cybozu.com/k/751/](https://jbis-kintone.cybozu.com/k/751/) **Space 48 / thread 52**・**v1 完成 — CLOSED** — メンバー検索・変更メモ・条件クリア・印刷/xlsx・浜田目視 OK **2026-06-29**・**BUILD=`2026-06-29-mailing-list-dash-clear-btn-v2`** rev **5** |
...
|-------------|----------|----------------|
| 2026-07-01T12:12:15Z | 595 | `customize/595/desktop.js` |
