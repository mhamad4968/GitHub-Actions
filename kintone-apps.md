...
| 756 | `2026-07-23-ver02-hscroll-fix` | **80** | `b6a303bc-3840-4b1e-9ca8-f22d1c8e92bb` | Ver.02 App1 fail-closed read-only shell |
...
| **実行予算書作成支援ツールver02**（App1・read-only shell） | **756** | `customize/jikkou-yosan-v2-app1/desktop.js` | [https://jbis-kintone.cybozu.com/k/756/](https://jbis-kintone.cybozu.com/k/756/) **Space 56 / thread 60**・3アプリ版メインUI・ACLは fail-closed read-only。**BUILD=`2026-07-23-ver02-hscroll-fix` rev **80** / fileKey **`b6a303bc-3840-4b1e-9ca8-f22d1c8e92bb`** |
| **実行予算ver02_内訳明細**（App2・read-only shell） | **757** | `customize/jikkou-yosan-v2-app2/desktop.js` | [https://jbis-kintone.cybozu.com/k/757/](https://jbis-kintone.cybozu.com/k/757/) **Space 56 / thread 60**・直接保存/削除ガード・ACLは fail-closed read-only。**BUILD=`2026-07-21-ver02-phase6-app2-readonly-guard` rev **15** / fileKey **`62efd690-efa5-4a79-b769-9219af3f8f16`** |
| **実行予算ver02_実績**（App3・read-only shell） | **758** | `customize/jikkou-yosan-v2-app3/desktop.js` | [https://jbis-kintone.cybozu.com/k/758/](https://jbis-kintone.cybozu.com/k/758/) **Space 56 / thread 60**・直接保存/削除ガード・ACLは fail-closed read-only。**BUILD=`2026-07-21-ver02-phase6-app3-readonly-guard` rev **14** / fileKey **`4766245e-c46d-432b-bf0a-aae189ffd183`** |
