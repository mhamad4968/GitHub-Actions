...
| 738 | `2026-06-21-total-network-dash-v1-conn-method-col` | **7** | `2736c1fe-4a7f-4a82-a206-18a73e84cead` | 2026-06-21 列名「接続方式」（値はIPアドレス固定） |
