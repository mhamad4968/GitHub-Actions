...
| 688 | `2026-07-10-688-wbgt-heat-reference` | **81** | `dc6ed705-941d-46c1-b57b-516dc7571db4` | 2026-06-24 過去5年降雨拡大 |
...
| **工事稼働日数ダッシュ（日常入口）** | **688** | `customize/688/desktop.js` \| `npm run deploy:688` | [https://jbis-kintone.cybozu.com/k/688/](https://jbis-kintone.cybozu.com/k/688/) **Space 56**・687 REST。**BUILD=`2026-07-10-688-wbgt-heat-reference` rev ** 81 **** rev **79** / fileKey **`dc6ed705-941d-46c1-b57b-516dc7571db4`**（施工主報告 **専用ウィンドウでA4横印刷**・**塗装/足場/休日各1枚**・**過去5年降雨1枚（6表横並び・拡大）**・風速別枚。**`cio:preflight:688` → `deploy:688`**）。仕様 **`docs/plans/2026-06-13-construction-workdays-excel-20260613.md`** §9–§10 |
