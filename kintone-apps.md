...
| 新・PC台帳ver.1（本体 / Day 4 雛形→Day 5 本実装・**構築中・運用開始前**） | **674** | `customize/new-pc-ledger-v1/desktop.js` | `npm run deploy:674` / Space **21** / thread **23** / **live revision 27**（2026-04-29 JST・§5.3 保存成功フック + §4.6.4 671 赤バナー・v0.2）/ customize **BUILD=`2026-04-29-day5-autogen-v0.2`** / fileKey **`74a0c4a2-c20c-4cae-8b4a-c5a8950c9dc7`** / field-spec **44/44**（Day4 手順書）/ **運用開始予定 2026-05-13**（仕様書 §1） |
