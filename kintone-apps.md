...
|-----|---------------|----------|---------|------|
| 595 | `2026-06-19-595-dept-picker-680` | **95** | `d9754327-5627-45e7-a3a4-78059977fcab` | 2026-06-19 680所属候補モーダル |
| 674 | `2026-06-19-674-detail-hide-sidebar` | **242** | `0dbb4061-8af0-4e77-8066-5efab2d3d1a9` | 2026-06-19 詳細画面 右サイドバー非表示 |
| 687 | `2026-06-09-687-workdays-excel-v1` | **10** | `13bc24dc-a753-404a-9f03-8e7e92c43647` | 2026-06-09 工事稼働 Excel v1 |
| 688 | `2026-06-19-688-print-rounding-fix` | **33** | `d6ea1231-552d-4966-802f-b6234be3208e` | 2026-06-19 足場風速日数丸め・印刷フッター削除 |
| 735 | — | — | — | 2026-06-18 実行予算書リストマスタ（104件 seed・customize なし） |
| 736 | `2026-06-18-jikkou-yosan-v10-bidir-codes` | **29** | `9645ddc7-7b43-41a7-829e-910ab19f6902` | 2026-06-18 工種CD↔名称双方向・行追加・連携緑・ジャンプ |
...
| 700 | `2026-06-18-bi-eval-role-ui-labels` | **141** | `704c383a-f29e-4ee2-858b-70c0bc127c35` | 2026-06-18 評価UIの部長/支店長/本社フェーズ別文言・ボタン |
...
| 734 | `2026-06-19-vpn-dash-license-month-compare` | **13** | `a0f30083-2cce-4573-8e5d-01c9bd8e0146` | 2026-06-19 ライセンス前回確定比較 |
...
| **工事稼働日数ダッシュ（日常入口）** | **688** | `customize/688/desktop.js` \| `npm run deploy:688` | [https://jbis-kintone.cybozu.com/k/688/](https://jbis-kintone.cybozu.com/k/688/) **Space 56**・687 REST。**BUILD=`2026-06-19-688-print-rounding-fix`** rev **33**（施工主報告印刷・足場風速日数丸め・印刷フッター削除）。仕様 **`docs/plans/2026-06-13-construction-workdays-excel-20260613.md`** |
...
| **【実行予算書】ver.01** | **736** | `customize/736/desktop.js` \| `npm run deploy:736` | [https://jbis-kintone.cybozu.com/k/736/](https://jbis-kintone.cybozu.com/k/736/) **Space 56 / thread 60**・735 REST・688型一覧+Excel風フォーム。**BUILD=`2026-06-18-jikkou-yosan-v10-bidir-codes`** rev **29**・サンプル **2623001-001** record **1**（`npm run jikkou-yosan:import-sample`）。仕様 **`docs/plans/2026-06-18-jikkou-yosan-spec.md`** §9 |
...
| 社員マスタ（674/714/716 連携） | 595 | `customize/595/desktop.js` | **本番 live 最終 deploy（2026-06-19）**: `npm run deploy:595` **SUCCESS** / fileKey **`d9754327-5627-45e7-a3a4-78059977fcab`** / preview revision **`95`** / **`BUILD=`** **`2026-06-19-595-dept-picker-680`**（新規・編集: **680 所属候補モーダル**で所属名・所属グループを一括入力・手入力も可）。**前 deploy（2026-06-17）**: rev **93** / **BUILD=`2026-06-17-595-emp-id-auto-assign`**（627 downstream 廃止 + **EMP-xxxx 保存時自動採番**） |
...
| 594 | `price` | 購入価格（経理連携） |
| 594 | `buyer` | 購入者・申請者記録 |
| 595 | `2026-06-19-595-dept-picker-680` | **95** |
...
| アプリ | ID | customize | BUILD（本番） | deploy |
|--------|-----|-----------|---------------|--------|
| JRシステム用iPad台帳DB | **720** | `customize/jr-ipad-db/desktop.js` | `2026-06-15-jr-ipad-db-block-ui-mutations` rev5 | `deploy:720` |
