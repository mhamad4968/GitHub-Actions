...
| 696 | `2026-06-21-696-search-panel` | **13** | `9eeed7c9-8952-4447-aa92-2984451db3a1` | 2026-06-21 検索パネル整理（チップ・部署・datalist） |
...
| **メールアドレス管理台帳**（日常 UI・695 へ REST） | **696** | `customize/shared-mail-dash/desktop.js` \| `npm run deploy:696` | [https://jbis-kintone.cybozu.com/k/696/](https://jbis-kintone.cybozu.com/k/696/) **Space 21 / thread 23**・接続設定パネル・新規 PW **`sjb`+乱数4桁+`1M#`**・印刷・利用種別 **共有／個人**・**検索パネル**（キーワード AND・状態／種別チップ・部署絞込）・**BUILD=`2026-06-21-696-search-panel`** rev **13**（2026-06-21 検索 UI 整理） |
