...
| 新・PC台帳ver.1（本体 / Day 4 雛形→Day 5 本実装・**構築中・運用開始前**） | **674** | `customize/new-pc-ledger-v1/desktop.js` | `npm run deploy:674` / Space **21** / thread **23** / **live revision 30**（2026-04-29 JST・個人 利用者名 595 候補 + 保存前社員照合・v0.5）/ customize **BUILD=`2026-04-29-day5-autogen-v0.5`** / fileKey **`a66ab921-148c-4284-8a76-7777268cbe2f`** / field-spec **44/44**（Day4 手順書）/ **運用開始予定 2026-05-13**（仕様書 §1） |
