...
| 756 | `2026-07-23-ver02-spec-s1s2s3` | **58** | `eb1d5cd8-92ed-4d28-afc4-7018e62710f9` | Ver.02 App1 fail-closed read-only shell |
| 757 | `2026-07-21-ver02-phase6-app2-readonly-guard` | **14** | `62efd690-efa5-4a79-b769-9219af3f8f16` | Ver.02 App2 direct-write guard / fail-closed read-only shell |
| 758 | `2026-07-21-ver02-phase6-app3-readonly-guard` | **13** | `4766245e-c46d-432b-bf0a-aae189ffd183` | Ver.02 App3 direct-write guard / fail-closed read-only shell |
...
| **実行予算書作成支援ツールver02**（App1・read-only shell） | **756** | `customize/jikkou-yosan-v2-app1/desktop.js` | [https://jbis-kintone.cybozu.com/k/756/](https://jbis-kintone.cybozu.com/k/756/) **Space 56 / thread 60**・3アプリ版メインUI・ACLは fail-closed read-only。**BUILD=`2026-07-23-ver02-spec-s1s2s3` rev **58** / fileKey **`eb1d5cd8-92ed-4d28-afc4-7018e62710f9`** |
| **実行予算ver02_内訳明細**（App2・read-only shell） | **757** | `customize/jikkou-yosan-v2-app2/desktop.js` | [https://jbis-kintone.cybozu.com/k/757/](https://jbis-kintone.cybozu.com/k/757/) **Space 56 / thread 60**・直接保存/削除ガード・ACLは fail-closed read-only。**BUILD=`2026-07-21-ver02-phase6-app2-readonly-guard` rev **14** / fileKey **`62efd690-efa5-4a79-b769-9219af3f8f16`** |
| **実行予算ver02_実績**（App3・read-only shell） | **758** | `customize/jikkou-yosan-v2-app3/desktop.js` | [https://jbis-kintone.cybozu.com/k/758/](https://jbis-kintone.cybozu.com/k/758/) **Space 56 / thread 60**・直接保存/削除ガード・ACLは fail-closed read-only。**BUILD=`2026-07-21-ver02-phase6-app3-readonly-guard` rev **13** / fileKey **`4766245e-c46d-432b-bf0a-aae189ffd183`** |
