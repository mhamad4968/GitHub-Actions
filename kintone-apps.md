...
| 699 | `2026-07-17-evaluator-action-button` | **130** | `ea35f5a7-0182-4e4f-9941-a92f49909417` | 2026-07-09 一覧アコーディオン+件数クリック開閉 |
...
| ご利用ガイド | **699** | `customize/business-improvement-guide/desktop.bundle.js` | **BUILD=`2026-07-17-evaluator-action-button` rev **130** — Q-GUIDE-13 サマリー表 + **一覧アコーディオン**（件数クリックで該当のみ開く） | `deploy:699` |
