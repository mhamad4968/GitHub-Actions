...
| 674 | `2026-07-31-674-inventory-date` | **265** | `dc112db9-a2ca-474c-8d23-960246d82072` | 2026-07-09 リスト出力 列選択+Excel（bundle deploy） |
...
| 719 | `2026-07-07-wifi-ssid-dash-list-print-scale2` | **12** | `880665eb-c661-40f8-9fdc-d36eda90f4fb` | 2026-07-07 一覧印刷・Excel・A4文字拡大 |
...
| 721 | `2026-06-24-jr-ipad-dash-register-existing` | **13** | `e4923d8c-aec1-4d3a-8b4a-f712d5c3d5e8` | 2026-06-24 既存端末を登録ボタン（採番なし・保存時POST） |
...
| 683 | `2026-08-02-683-print-2page-landscape-readable-v3` | **90** | `02b6a9c1-d5ac-4c3e-aa6b-d943c0fc4c31` | 2026-05-16 registry 整合 |
...
| **Apple ID管理台帳**（日常 UI・693 へ REST） | **694** | `customize/apple-id-dash/desktop.js` \| `npm run deploy:694` | [https://jbis-kintone.cybozu.com/k/694/](https://jbis-kintone.cybozu.com/k/694/) **Space 21 / thread 23**・**2026-06-06**: 編集で **Apple ID・PW・ロック** 修正可・**BUILD=`2026-06-08-694-device-exchange-date` rev **18** / fileKey **`699da986-7b14-49d0-aafe-bfe3322300e5`** |
...
| **JRシステム用iPad管理台帳 ver.1**（日常 UI・720 へ REST） | **721** | `customize/jr-ipad-dash/desktop.js` \| `npm run deploy:721` | [https://jbis-kintone.cybozu.com/k/721/](https://jbis-kintone.cybozu.com/k/721/) **Space 34 / thread 38**・**BUILD=`2026-06-24-jr-ipad-dash-register-existing` rev **13** / fileKey **`e4923d8c-aec1-4d3a-8b4a-f712d5c3d5e8`** |
