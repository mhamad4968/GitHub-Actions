...
| 747 | `2026-07-18-jre-chub-account-dash-v7-proxy-restore` | **13** | `08698457-d0e0-4c92-a835-2c8fe4be15b9` | 2026-07-18 署名代行対象・利用再開・湾岸工事所 |
...
| **JRE-C_Hubアカウント台帳**（日常 UI・746 へ REST） | **747** | `customize/jre-chub-account-dash/desktop.js` \| `npm run deploy:747` | [https://jbis-kintone.cybozu.com/k/747/](https://jbis-kintone.cybozu.com/k/747/) **Space 34 / thread 38**・745 型 — 権限 ST/フィルタ・署名代行対象の社員検索・利用再開・湾岸工事所・IDユニーク集計・一覧/集計 xlsx+印刷・**BUILD=`2026-07-18-jre-chub-account-dash-v7-proxy-restore` rev **13** / fileKey **`08698457-d0e0-4c92-a835-2c8fe4be15b9`** |
...
| JRE-C_Hubアカウント台帳 | **747** | `customize/jre-chub-account-dash/desktop.js`（`desktop.src.js` + SheetJS bundle） | `2026-07-18-jre-chub-account-dash-v7-proxy-restore` rev13 | `deploy:747`（前に `jre-chub:bundle-dash`） |
...
| 日付 | 変更内容 |
|------|----------|
| 2026-07-18 | **JRE-C_Hub 746/747更新**: 746フォーム rev8（署名代行対象ST・湾岸工事所）、747 rev13（社員検索・利用再開・一覧/検索/出力対応）。既存48件は一括更新なし |
