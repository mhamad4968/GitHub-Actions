...
| 688 | `2026-06-24-688-print-5yr-rain-compact-v8` | **77** | `00abed71-9948-4216-b427-44d26034ec36` | 2026-06-24 過去5年降雨1枚収め |
...
| **工事稼働日数ダッシュ（日常入口）** | **688** | `customize/688/desktop.js` \| `npm run deploy:688` | [https://jbis-kintone.cybozu.com/k/688/](https://jbis-kintone.cybozu.com/k/688/) **Space 56**・687 REST。**BUILD=`2026-06-24-688-print-5yr-rain-compact-v8`** rev **77** / fileKey **`00abed71-9948-4216-b427-44d26034ec36`**（施工主報告 **専用ウィンドウでA4横印刷**・**塗装/足場/休日各1枚**・**過去5年降雨1枚（6表横並び）**・風速別枚。**`cio:preflight:688` → `deploy:688`**）。仕様 **`docs/plans/2026-06-13-construction-workdays-excel-20260613.md`** §9–§10 |
