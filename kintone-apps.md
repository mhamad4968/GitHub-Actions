...
| 756 | `2026-07-23-ver02-736-chrome` | **66** | `7a0fb2e3-118b-4b69-b9c3-53cddf9e678e` | Ver.02 App1 fail-closed read-only shell |
...
| **実行予算書作成支援ツールver02**（App1・read-only shell） | **756** | `customize/jikkou-yosan-v2-app1/desktop.js` | [https://jbis-kintone.cybozu.com/k/756/](https://jbis-kintone.cybozu.com/k/756/) **Space 56 / thread 60**・3アプリ版メインUI・ACLは fail-closed read-only。**BUILD=`2026-07-23-ver02-736-chrome` rev **66** / fileKey **`7a0fb2e3-118b-4b69-b9c3-53cddf9e678e`** |
