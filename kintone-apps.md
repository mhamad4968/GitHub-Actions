...
| 688 | `2026-07-13-688-heat-closed` | **89** | `b44d6720-4fd7-4118-b456-b85bb0ec9bbd` | 2026-07-13 気象ヘルプ・猛暑日オプション折りたたみ |
...
| **工事稼働日数ダッシュ（日常入口）** | **688** | `customize/688/desktop.js` \| `npm run deploy:688` | [https://jbis-kintone.cybozu.com/k/688/](https://jbis-kintone.cybozu.com/k/688/) **Space 56**・687 REST。**BUILD=`2026-07-13-688-heat-closed` rev **89** / fileKey **`b44d6720-4fd7-4118-b456-b85bb0ec9bbd`**（施工主報告 **専用ウィンドウでA4横印刷**・**塗装/足場/休日各1枚**・**過去5年降雨1枚（6表横並び・拡大）**・風速別枚·**気象ヘルプ/猛暑日オプション折りたたみ**。**`cio:preflight:688` → `deploy:688`**）。仕様 **`docs/plans/2026-06-13-construction-workdays-excel-20260613.md`** §9–§10 · UI追補 **`docs/plans/2026-07-13-688-weather-ui-accordion-spec.md`** |
