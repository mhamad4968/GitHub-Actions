...
| **部署予実・ダッシュ**（**集計管理の主画面**・俯瞰・入力アプリ参照） | **678** | `customize/678/desktop.js` \| `npm run deploy:678` | [https://jbis-kintone.cybozu.com/k/678/](https://jbis-kintone.cybozu.com/k/678/)・入力と同スペース。**2026-04-29** 枠のみ deploy **SUCCESS**。**2026-05-02**: 677 明細表・備考・`display_order` PUT・API 失敗メッセージ deploy **SUCCESS** / fileKey **`5f992f52-5148-4b10-b7fb-e018ff0bf8bf`** / rev **7**。**2026-05-03**（§10.1）: リンク集・運用メモ・利用注意・費用種別フィルタ・定額/変動枠列・`$revision` 明示取得・**BUILD=`2026-05-03-678-dashboard-milestone`** deploy **SUCCESS** / fileKey **`0e77462b-36e9-4406-8cc9-25ceb0581fdc`** / preview revision **8**。`SPEC.md` §6b・§6e |
