...
| 715 | `2026-06-14-software-ledger-dash-v1` | **4** | `79d1a058-abf9-4eb9-94c6-123671cbd5a7` | 2026-06-14 ソフトウエア管理台帳 ver.1 |
...
| **ソフトウエア管理台帳ver.1**（日常 UI・714 へ REST） | **715** | `customize/software-ledger-dash/desktop.js` \| `npm run deploy:715` | [https://jbis-kintone.cybozu.com/k/715/](https://jbis-kintone.cybozu.com/k/715/) **Space 21 / thread 23**・**2026-06-14**: 595 連携・識別3スロット・リスト印刷・**BUILD=`2026-06-14-software-ledger-dash-v1`** |
