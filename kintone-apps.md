...
|-----|---------------|----------|---------|------|
| 595 | `2026-08-21-595-sync-roster-776-on-save` | **136** | `b5557815-9788-40f3-9685-6e1e44a6ce8b` | 2026-08-19 715共有設置先は社員ミラー対象外 |
...
| 社員マスタ（674/714/716 連携） | **595** | `customize/595/desktop.js` | **本番 live 最終 deploy（2026-08-13）**: `npm run deploy:595` → **BUILD=`2026-08-21-595-sync-roster-776-on-save` rev **136** / fileKey **`b5557815-9788-40f3-9685-6e1e44a6ce8b`** （削除済み594 `pc_ledger_list` 参照除去・退職時は `pc_ledger_v1_list` のみクリア）。一括反映ログは **697 `bulk_downstream_595_log`**（595 の形骸 `bulk_downstream_sync_log` は削除）。**前**: 2026-07-04 fileKey `e47d849c-…` rev **116** / `2026-07-04-595-index-emp-dept-filters` |
