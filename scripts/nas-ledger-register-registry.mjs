...
import { loadAppIds } from './lib/nas-ledger-kintone.mjs';
...
run(['--dir', 'nas-ledger-db', '--app', String(dbAppId)]);
run(['--dir', 'nas-ledger-dash', '--app', String(dashAppId), '--bundle-npm', 'nas-ledger:bundle-dash']);
