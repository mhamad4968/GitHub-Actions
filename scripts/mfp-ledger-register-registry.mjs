...
import { loadAppIds } from './lib/mfp-ledger-kintone.mjs';
...
run(['--dir', 'mfp-ledger-db', '--app', String(dbAppId)]);
run(['--dir', 'mfp-ledger-dash', '--app', String(dashAppId), '--bundle-npm', 'mfp-ledger:bundle-dash']);
