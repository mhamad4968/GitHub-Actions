/**
 * 工事稼働日数算出 — 計算コア（SPEC §4–§5 / 検証レポート準拠）
...
export function holidayTotalForMonth(y, m) {
...
export function monthlyCountGe(rows, threshold) {
  const acc = new Map();
...
export function weatherUnionCount(rain, hum, y, m, rainTh, humTh) {
  const bad = new Set();
