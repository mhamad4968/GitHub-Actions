...
const MARKERS = [
  ...
  { file: 'scripts/cio-grok-execution-guard.mjs', needles: ['--validate-contract', '--validate-diff'] },
  { file: 'scripts/cio-session-cold-start.mjs', needles: ['--session-reset', 'clearWarnEscalation'] },
