#!/usr/bin/env node
/**
 * App 736 — PH1e spec_category サブテーブル列追加 + deploy
 *   npm run jikkou-yosan:add-ph1e-spec-category
 */
...
const PATCH_PATH = path.join(path.dirname(fileURLToPath(import.meta.url)), 'data', 'jikkou-yosan-ph1e-spec-category-patch.json');
...
async function main() {
  ...
  console.log('Deployed app', appId, '— PH1e spec_category OK');
}
