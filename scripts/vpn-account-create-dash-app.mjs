#!/usr/bin/env node
/**
 * VPN アカウント — Dash app create (Space 48 / thread 52)
 * 正本: docs/plans/2026-06-16-vpn-account-kintone-spec.md §3 / §8
 */
import {
  DASH_APP_NAME,
  SPACE_ID,
...
async function main() {
  ...
  if (!dbAppId) {
    console.error('dbAppId missing. Run vpn-account:create-db first.');
    process.exit(1);
  }
