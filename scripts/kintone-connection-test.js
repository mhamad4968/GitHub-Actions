/**
 * Kintone 疎通確認（認証・595/627 + 670/671/672/673/674 のアプリ設定が読めるか）。
 ...
 *
 * 旧 PC 台帳スタック: 595/627（626 は本番から削除済みのため対象外。採番後継は 672）
...
/** 626 は GAIA 上削除済み（404）。kintone-apps.md の 672 が採番系の後継。594 は廃止予定のため既定では除外（INCLUDE_LEGACY_APP_594=1 で先頭に追加）。 */
const PC_STACK_APPS = [
  ...(process.env.INCLUDE_LEGACY_APP_594 === '1' ? [594] : []),
  595, 627, 670, 671, 672, 673, 674,
];
