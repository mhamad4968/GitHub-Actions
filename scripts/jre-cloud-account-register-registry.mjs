...
import { loadAppIds } from './lib/jre-cloud-account-kintone.mjs';
...
run(['--dir', 'jre-cloud-account-db', '--app', String(dbAppId)]);
run(['--dir', 'jre-cloud-account-dash', '--app', String(dashAppId), '--bundle-npm', 'jre-cloud:bundle-dash']);
