...
| ID | 状態 |
|----|------|
| #R736-CAL-01 | **GO**（2026-07-05 浜田） |
| #R736-SYNC-01 | **GO** |
| #S-SKYSEA-01 | **GO** |
| #S-712-DEL-01 | **GO** |
| #D-DEPLOY-712-01 | **GO**（実装済） |
| #S-CLOSE-02 | **GO** → R-SESS-07 |
| **#R-ORIENT-07** | **GO** — 本日予定 → 依頼の順 |

実施正本: `docs/approved-changes/2026-07-05-evening-improvements-hamada-go.md`
