# 🌅 朝のブリーフィング — 2026-04-25 (Sat) 06:00
...
#### 2026-04-24-pc-ledger-day1-day2-action.md

- L118: - [ ] kintone-get-app で APP_ID + name + space 確認
- L119: - [ ] kintone-get-records で 12 件全件取得 → CSV と差異ゼロ確認
- L120: - [ ] `M365_DOMAIN` の値が `@kensetsutoso01.onmicrosoft.com` (先頭 @ あり) であること
- L121: - [ ] `M365_LICENSE_LIMIT` の値が `5` であること (整数文字列)
- L122: - [ ] `category` がすべて DROPDOWN の 5 選択肢のいずれか (誤字なし)
- L273: - [ ] kintone-get-app で APP_ID + name + space 確認
- L274: - [ ] kintone-get-records で 10 件全件取得 → CSV と差異ゼロ確認
- L275: - [ ] `m365_id` がすべて `sjm-NNN@kensetsutoso01.onmicrosoft.com` 形式 (3 桁ゼロ埋め)
- L276: - [ ] `serial_no` が 1-10 の連番
- L277: - [ ] `usage_count` がすべて 0 (整数)
- ...他 21 件

#### 2026-04-25-pc-ledger-day3-action.md

- L57: - [ ] 2 アプリとも本番に存在し、フィールドが `npm run app:fields` と一致
- L58: - [ ] `kintone-apps.md` 更新履歴に 4/25 行が付く
...
Failed:    0
Total chunks: 1321
[90/91] /home/mhamada202408224/kintone-ai-lab/docs/security-news-app-troubleshoot.md ... OK (10 chunks)
...
```text
{"time":"2026-04-24T12:57:37.173Z","file":"AGENTS.md","old_size":157710,"new_size":0,"parent_pid":41914,"self_pid":41917}
...
- `2026-04-24-pc-ledger-day1-day2-action.md` L3: **作成日時**: 2026-04-24 (Fri) 18:15 JST
- `2026-04-24-pc-ledger-day1-day2-action.md` L381: **最終更新**: 2026-04-24 (Fri) 18:15 JST

### 直近の計画ファイル（3 件）

- `docs/plans/2026-04-25-pc-ledger-day3-action.md` （更新: 2026-04-24 12:57）
- `docs/plans/2026-04-25-raci-transparency.md` （更新: 2026-04-24 12:57）
- `docs/plans/2026-04-24-pc-ledger-day1-day2-action.md` （更新: 2026-04-24 09:13）

**AI への指示例**:
```
「2026-04-25-pc-ledger-day3-action.md の続きを進めて」
```
