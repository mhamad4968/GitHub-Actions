# 🌅 朝のブリーフィング — 2026-08-14 (Fri) 06:00
...
- 直近消費: 🟢 33% (2026-08-13) — OK / 通常運用継続
- 月予算: L1 $200 (Ultra) + L2 $1000 (On-Demand cap) = **$1200**
- 課金日: 毎月 15 日 / 次回リセット **2026-08-15** (残 **1** 日)
- 線形回帰予測 枯渇日: **2026-10-17** ✅ リセット日以降
- AI 助言: 通常運用継続 OK
- 履歴件数: 29 日分
...
### 🤖 自律判断ログ（2026-08-13 / autonomy scan）
...
**朝報生成時刻**: 2026-08-14T06:00:12.999+09:00 (この時刻以降の編集は翌朝報で確認)
...
- NVM v24 スタック（cron・MCP・朝 prep 正本）:
  ...
  - **NVM v24 整合**: ✅ 100%
- Disk (`~`): 207.2G used / 252.3G free on C: — ✅
  - npm cache: 2.4G / npx cache: 1.8G
- Memory: 12655/15894 MiB (80%) — ✅
