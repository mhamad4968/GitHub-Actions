# 🌅 朝のブリーフィング — 2026-08-03 (Mon) 06:00
...
- 直近消費: 🟢 24% (2026-08-02) — OK / 通常運用継続
- 月予算: L1 $200 (Ultra) + L2 $1000 (On-Demand cap) = **$1200**
- 課金日: 毎月 15 日 / 次回リセット **2026-08-15** (残 **12** 日)
- 線形回帰予測 枯渇日: **2026-09-21** ✅ リセット日以降
- AI 助言: 通常運用継続 OK
- 履歴件数: 24 日分
...
### 🤖 自律判断ログ（2026-08-02 / autonomy scan）
...
globals   17.8.0  17.8.0  17.9.0  node_modules/globals  kintone-ai-lab
```
...
**朝報生成時刻**: 2026-08-03T06:00:15.176+09:00 (この時刻以降の編集は翌朝報で確認)
...
**総合**: 正常 33 / 異常 0 / 警告 1 / スキップ 2
**健全性スコア**: 97%（判定対象 34 項目・スキップ 2 は別枠）
...
- `docs\plans\2026-05-08-user-support-daily-counts-spec.md` （更新: 2026-08-02 10:28）
- `docs\plans\2026-05-15-user683-monthly-pdf-layout-spec.md` （更新: 2026-08-02 10:28）
- `docs\plans\2026-04-18-skysea-installer.md` （更新: 2026-08-02 08:21）

**AI への指示例**:
```
「2026-05-08-user-support-daily-counts-spec.md の続きを進めて」
```
