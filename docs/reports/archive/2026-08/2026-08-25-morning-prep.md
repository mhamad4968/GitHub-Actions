# 🌅 朝のブリーフィング — 2026-08-25 (Tue) 06:00
...
- 課金日: 毎月 15 日 / 次回リセット **2026-09-15** (残 **21** 日)
...
### 🤖 自律判断ログ（2026-08-24 / autonomy scan）
...
**朝報生成時刻**: 2026-08-25T06:00:17.996+09:00 (この時刻以降の編集は翌朝報で確認)
...
[constitution-aide-trial] 21 files → .rag\extra-docs\constitution-aide-trial (sync-only)
[constitution-aide-trial] skip vector ingest (--sync-only)
...
---
[rag-aide-smoke] needle miss in checkpoint-latest.md: 完了済
[rag-aide-smoke] FAIL 1
```
...
**総合**: 正常 12 / 異常 19 / 警告 0 / スキップ 1
**健全性スコア**: 39%（判定対象 31 項目・スキップ 1 は別枠）
...
 �0�0�0  �0�0�0:   W s l / S e r v i c e / E _ U N E X P E C T E D  
 ` (npm `�}T�vj0�0�0�0g0Y00   
 �0�0�0  �0�0�0:   W s l / S e r v i c e / E _ U N E X P E C T E D  
 `)
...
 `
  - **NVM v24 整合**: ❌ 未達
- Disk (`~`): 213.2G used / 246.3G free on C: — ✅
  - npm cache: 2.6G / npx cache: 1.8G
- Memory: 10449/15894 MiB (66%) — ✅
- cron: ❌ morning:prep 未登録
...
| 操作 | 結果 |
|---|---|
| logs ローテ | ✅ `morning(0) health(1) heal(0)` |
