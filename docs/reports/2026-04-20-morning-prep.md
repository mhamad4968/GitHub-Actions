# 🌅 朝のブリーフィング — 2026-04-20 (Mon) 06:00
...
| ID | 状態 | 備考 |
|---|---|---|
| C1-627-username-mismatch-ui | 📝 | manual_only は自動禁止。手順案内のみ |
| C2-594-skysea-toggle | 📝 | manual_only は自動禁止。手順案内のみ |
| D1-troubleshooting-quick-table | ✅ | 置換完了 (1 件) |
| D2-skysea-plan-toc | ✅ | 置換完了 (1 件) |
| D3-new-session-starter-auto-update | 📝 | manual_only は自動禁止。手順案内のみ |
| D4-chat-sessions-2026-04-19-summary | ✅ | 置換完了 (1 件) |
| K1-594-skysea-fields | 📝 | K カテゴリ は自動禁止。手順案内のみ |
| R1-section-39-2turn-rule | ✅ | 置換完了 (1 件) |
| R2-section-33a-kintone-api-trigger | ✅ | 置換完了 (1 件) |
| R3-section-47-batch-edit-guard | ✅ | 置換完了 (1 件) |
| R4-section-42-ai-ritual | ✅ | 置換完了 (1 件) |
| R5-claude-md-line-ending | ✅ | 置換完了 (1 件) |
| S1-morning-prep-wipe-incidents | 📝 | manual_only は自動禁止。手順案内のみ |
| S2-evening-reflect-strengthen | 📝 | manual_only は自動禁止。手順案内のみ |
| S3-skysea-recon-category-summary | 📝 | manual_only は自動禁止。手順案内のみ |
| S4-wipe-guard-notify | 📝 | manual_only は自動禁止。手順案内のみ |
...
Failed:    0
Total chunks: 737
[42/43] /home/mhamada202408224/kintone-ai-lab/docs/security-news-app-troubleshoot.md ... OK (10 chunks)
Parsed MD: /home/mhamada202408224/kintone-ai-lab/docs/troubleshooting.md (9340 characters)
```
