...
**初版作成**: 2026-04-23 (Thu) / **最終更新**: 2026-07-15（現行ステータスバナー · mintlify DEL-1 追認）
...
| **cyber-news** | user `mcp.json` **不在**（DEL-2 正式クローズは浜田再GO + runbook確認後） |
...
| 2 | cyber-news | ✅ active | 0 回（exempt） | サイバーセキュリティニュース取得 | 5/1（月次健康診断）|
