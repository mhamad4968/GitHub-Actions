...
| 6 | memory | ✅ **active 化済** | **3 回** | セッション横断記憶 (現在 10 entities + 11 relations) | PC 台帳 PJ で実戦投入後判断（5/13 頃）|
...
| 11 | **kintone-space (自作)** | ✅ active | **6 回** | kintone スペース操作 | **4/24 環境設定マスタ作成時に実戦投入予定** |
