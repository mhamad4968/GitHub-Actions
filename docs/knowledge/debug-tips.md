...
**手順**: `npm run cio:session:cold-start` → `npm run cio:report-verify-response -- --file <下書き>`**、締め・GO 仰ぎは **`npm run cio:close-report-verify-response -- --file <下` → `npm run cio:report-verify-response -- --file <下書き>`**、締め・GO 仰ぎは **`npm run cio:close-report-verify-response -- --file <下`
...
<!-- errors: exit1 / #CON-01/02 等実装・push済（`e6e6eef4` 系） | npm run cio:session:cold-start` | npm run cio:report-verify-response -- --file <下書き>`**、締め・GO 仰ぎは **`npm run cio:c -->
