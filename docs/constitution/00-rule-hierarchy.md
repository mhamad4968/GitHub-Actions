...
| 8 | **`npm run verify:cio-four-ai-governance`** | A+C + turn-head + MCP 同期 一括 |
| 9 | **`.cursor/hooks/cio-four-ai-interlock.mjs`** | deploy / commit 前の deny |
| 10 | **`git-hooks/pre-commit`** | staged 時の 5038 + Composer 検査 |
