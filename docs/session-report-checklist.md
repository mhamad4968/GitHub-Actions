...
**2026-08-11（T5 / CON-3）**: 機能区切りで `git status` が ahead なら **push → CI 緑**まで報告前に完了（未 push＝検証ゼロ）。複製／買替障害は form 必須を先確認（MCP-1）。正本: `docs/runbooks/cio-ops-2026-08-11-evening-improvements.md`。
