...
| # | 論点 | 合意 | 実装 | verify |
|---|------|:----:|:----:|:----:|
| 1 | **H8 ティア L2 固定**（軽微 doc L1 許容か · v3.3 Lite 整合） | [ ] | [ ] | [ ] |
| 2 | **AGENTS 統合**（索引化優先 · rules-opt §2 R5） | [ ] | [ ] | [ ] |
| 3 | **新憲法要否**（現行 § + runbook/npm で足りるか CEO 判断） | [ ] | [ ] | [ ] |
| 4 | **§50-3-8 / turn-start 形骸化**（2 週後 △2→低 降格可否） | [ ] | [ ] | [ ] |
| — | **締め** commit/push · handoff · Desktop sync | — | — | [ ] |
