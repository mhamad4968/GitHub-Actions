...
> **目的**: 浜田 GO — 仕様詰め → 早々に実装 → **使用感を見れる**状態にする。  
> **前提**: v2c 差分プレビュー（画面）は **本番稼働・バグ解消済み**（BUILD `2026-06-23-jikkou-yosan-diff-structural-match` rev **123**）。
...
| Q4 | 差分サマリー印刷 | 1枚目に要約を載せるか | **Step2 以降**（まず色付けのみ） |
