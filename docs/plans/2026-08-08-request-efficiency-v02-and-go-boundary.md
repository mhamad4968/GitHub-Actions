...
> **完了通知（音）**: **最後** — 夜相談用仕様 `docs/plans/2026-08-08-done-notify-v2n-night-consult-spec.md`（実装は合意＋実装GO後）  
...
| 4 | V2-3 レーン別デフォルト | **済** |
| 5 | 完了通知 | **仕様済**（夜相談→実装GO） · `2026-08-08-done-notify-v2n-night-consult-spec.md` |
| 6 | ② MCP月次 | **済** |
