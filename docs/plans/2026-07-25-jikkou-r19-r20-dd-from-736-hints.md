...
1. ~~R-19: プロファイル別欠番・表記ゆれ棚卸し~~ → **Step1 済**
2. ~~R-20 vendors × 明細I 役割分担~~ → **Step2 済**
3. **次手候補**: 735単位セット差分／code_row×kindLong 表記ゆれ／依頼者向け「明細I＝取引先と同義か」1問
4. 736 画面の操作感は **目視ヒントのみ**（customize/736 編集・deploy しない）
