...
### 11.3a 気象データヘルプ（照合・監査用 · 2026-07-13）
...
| 正本 | [`2026-07-13-688-weather-ui-accordion-spec.md`](2026-07-13-688-weather-ui-accordion-spec.md) §1 |
...
| **オプション** | 画面表示 ON/OFF · 印刷 ON/OFF（既定 OFF）· **アコーデオン UI**（[`2026-07-13-688-weather-ui-accordion-spec.md`](2026-07-13-688-weather-ui-accordion-spec.md)） |
| **688 保留** | **本件のみ部分解凍** — 他改修は触らない |

AIチームレビュー: **問題なし（2026-07-10）** — **implement 完了**（浜田目視 OK 2026-07-13 · rev89）。
