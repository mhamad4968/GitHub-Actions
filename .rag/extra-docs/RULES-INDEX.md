...
| §35 | 自律型エンジニアリング（**§35-1 開発=AI／確認=浜田・変更禁止** = §56-1a と同義。**§35-6** セッション成果物の削除ゲート・2026-05-04） |
| §36 | デュアルラン（キー移行の安全策）|
| §38 | ツール・依存関係の自律保守 |
