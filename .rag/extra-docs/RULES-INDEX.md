...
| §50-3 / **§50-3-8** / **§50-3-9** / **§50-3-10** | **CTO運用規定**（コスト・自律・安全 / PlanB / **航海図 vs §51** / **CEO 差し替え** / 安価MCP 3回or5分 / サニタイズ / 憲法適合＋コマンド併記 / §41 相談 / **§50-3-8 盲点・DeepSeek 着手前＋突合メモ** / **§50-3-9 kintone MCP 失敗時の REST 自律迂回**（構造エラー再試行禁止・通信1回・`tmp-kintone-*` 掃除）/ **§50-3-10 `.cursorrules` 鏡像** / 2026-04-29–30）／**仕様確認の分業正本**: `.cursor/rules/deepseek-cursor-spec-division.mdc`（DeepSeek 一次・Cursor セカンド・2026-05-01）|
...
| §50-3 / **§50-3-8** / **§50-3-9** / **§50-3-10** | **CTO運用規定**（航海図・PlanB・§51 分離・CEO 差し替え・検収証跡・**§50-3-8 DeepSeek 盲点＋突合メモ**・**§50-3-9 kintone MCP→REST 迂回**・**§50-3-10 鏡像** / 2026-04-29–30）／**仕様確認分業**: `.cursor/rules/deepseek-cursor-spec-division.mdc` |
