...
| **部署予実・ダッシュ**（**集計管理の主画面**・俯瞰・入力アプリ参照） | **678** | `customize/678/desktop.js` \| `npm run deploy:678` | [https://jbis-kintone.cybozu.com/k/678/](https://jbis-kintone.cybozu.com/k/678/)・入力と同スペース。**2026-04-29** 枠のみ deploy **SUCCESS**。**2026-05-02**: customize 骨格 deploy **SUCCESS** / fileKey **`2a369241-9d28-490b-8f75-eae28bca6d7d`** / preview revision **3** / **BUILD=`2026-05-02-678-dashboard-shell`**。`SPEC.md` §6b・§6e |
