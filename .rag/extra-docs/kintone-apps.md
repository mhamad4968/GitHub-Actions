...
| 674 | `2026-07-17-674-note-search-checkbox` | **262** | `70986676-e0d8-406b-8c00-b438bc240c01` | 2026-07-09 リスト出力 列選択+Excel（bundle deploy） |
...
| 756 | `2026-07-28-ver02-pane-tint` | **156** | `41e1b7ca-60cc-48e7-bf4b-175fd0a20a3b` | Ver.02 App1 fail-closed read-only shell |
...
| 770 | `2026-07-28-tokai-ipad-dash-v3-print-dense-design` | **15** | `9c11a03d-a1cf-473d-824c-28ebd16e0477` | 2026-07-28 東海支店iPad Dash v1（一覧・採番・印刷・Excel・同期） |
...
| **工事稼働日数ダッシュ（日常入口）** | **688** | `customize/688/desktop.js` \| `npm run deploy:688` | [https://jbis-kintone.cybozu.com/k/688/](https://jbis-kintone.cybozu.com/k/688/) **Space 56**・687 REST。**BUILD=`2026-07-13-688-heat-closed` rev **90** / fileKey **`b44d6720-4fd7-4118-b456-b85bb0ec9bbd`**（施工主報告 **専用ウィンドウでA4横印刷**・**塗装/足場/休日各1枚**・**過去5年降雨1枚（6表横並び・拡大）**・風速別枚·**気象ヘルプ/猛暑日オプション折りたたみ**。**`cio:preflight:688` → `deploy:688`**）。仕様 **`docs/plans/2026-06-13-construction-workdays-excel-20260613.md`** §9–§10 · UI追補 **`docs/plans/2026-07-13-688-weather-ui-accordion-spec.md`** |
...
| **実行予算書作成支援ツールver02**（App1・read-only shell） | **756** | `customize/jikkou-yosan-v2-app1/desktop.js` | [https://jbis-kintone.cybozu.com/k/756/](https://jbis-kintone.cybozu.com/k/756/) **Space 56 / thread 60**・3アプリ版メインUI・ACLは fail-closed read-only。**BUILD=`2026-07-28-ver02-pane-tint` rev **156** / fileKey **`41e1b7ca-60cc-48e7-bf4b-175fd0a20a3b`** |
...
| **東海支店iPad管理台帳**（日常 UI・769 へ REST） | **770** | `customize/tokai-ipad-dash/desktop.js` \| `npm run deploy:770` | [https://jbis-kintone.cybozu.com/k/770/](https://jbis-kintone.cybozu.com/k/770/) **Space 32 / thread 34**・**BUILD=`2026-07-28-tokai-ipad-dash-v3-print-dense-design` rev **15** / fileKey **`9c11a03d-a1cf-473d-824c-28ebd16e0477`**・ACL=tokai+admin・Lookup なし・595/674 は admin 直／tokai は同期中継（`docs/runbooks/tokai-ipad-sync-relay.md`） |
