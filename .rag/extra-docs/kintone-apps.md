...
| 719 | `2026-08-03-wifi-ssid-dash-employee-only-notice` | **13** | `3fc9c8e4-a0d3-47df-b10a-124edeaa888e` | 2026-07-07 一覧印刷・Excel・A4文字拡大 |
...
| **社内Wi-Fi管理台帳 ver.1**（日常 UI・718 へ REST） | **719** | `customize/wifi-ssid-dash/desktop.js` \| `npm run deploy:719` | [https://jbis-kintone.cybozu.com/k/719/](https://jbis-kintone.cybozu.com/k/719/) **Space 21 / thread 23**・694 型一覧・拠点別 A4 印刷（Wi-Fi QR）・**一覧印刷・Excel出力**（検索絞込・PW 含む）・**BUILD=`2026-08-03-wifi-ssid-dash-employee-only-notice` rev **13** / fileKey **`3fc9c8e4-a0d3-47df-b10a-124edeaa888e`** |
