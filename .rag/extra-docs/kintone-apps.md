...
| **PC台帳簡単ガイドライン**（事務向けクイックガイド・短文＋図中心・**一覧上段に Web 風リーダー**） | **681** | `customize/681/desktop.js` \| `npm run deploy:681` | **Space 21 / thread 23**・[スペース 21](https://jbis-kintone.cybozu.com/k/#/space/21)・[アプリ](https://jbis-kintone.cybozu.com/k/681/)。**2026-05-06**: REST `scripts/create-pc-ledger-quick-guide-app.mjs`（`npm run pc-ledger:quick-guide:create-app`）でアプリ作成。**表示名**は `pc-ledger:quick-guide:set-app-name`。**一覧**: `app.record.index.show` で **カード型リーダー**。**既定は一覧非表示**・ボタンで編集用一覧を表示（679 と同趣旨）。初期 **9 章**（メタ章2件は `prune-meta` で削除・**7 章**）。フィールド: `sort_no`・`midashi`・`honbun`・`gazou_1`〜`3`。利用者向けに **アプリ番号や IT 用語を出さない**運用。**2026-05-06**: customize deploy **SUCCESS** / fileKey **`1da37163-dde8-43a6-8c73-f1763abdab9b`** / preview revision **`9`** / **BUILD=`2026-05-06-681-reader-hide-list-toggle`**。**2026-05-06（続）**: **横スクロール目次**（章ジャンプ）・**広い画面は多列**・**イラスト欄が空なら SVG**。**deploy SUCCESS** / fileKey **`de67464b-78fd-418b-973b-0fbf9ce2b7e8`** / preview revision **`11`** / **BUILD=`2026-05-06-681-toc-grid-inline-svg`**。**2026-05-06（続）**: メタ章 **非表示**＋当時 **`prune-meta:apply`** で削除済（**現行** `prune-meta` は **既定 dry-run**／本削除は **`prune-meta:apply`**）。**deploy SUCCESS** / fileKey **`2180a413-e074-4692-8e98-564f869e3322`** / preview revision **`12`** / **BUILD=`2026-05-06-681-prune-meta-chapters`**。**2026-05-06（続）**: **検索章** `upsert-search`・**見出し別 SVG 常時＋FILE 併用**。**deploy SUCCESS** / fileKey **`e7a45078-816e-4931-be8a-a2210adbe5aa`** / rev **`13`** → **`ad5eda2a-4c89-40a2-a279-25f880287513`** / rev **`14`** / **BUILD=`2026-05-06-681-search-themed-thumbs-subnote`**。**続**: 五章 `upsert-five-topics`・**BUILD=`2026-05-06-681-five-topics-thumbs`** / fileKey **`f2420f33-fb7c-45a4-8cac-e26d1f1473b8`** / rev **`15`** → **表示順バッジ削除** fileKey **`38438b02-e3f3-465b-ade4-1aaafbb8e1ba`** / rev **`16`** / **BUILD=`2026-05-06-681-hide-sort-badge`**。**2026-05-06（続・運用ゲート）**: **`npm run app:fields 681`＝API 14 件**（業務: `sort_no`・`midashi`・`honbun`・`gazou_1`〜`3` ＋システム）。**レコード DELETE**: `docs/kintone-destructive-operations.md`・**`pc-ledger:quick-guide:prune-meta` は既定 dry-run のみ**・本削除は **`prune-meta:apply`**（チャットに dry-run 貼付＋「この一覧で削除 GO」後）。Cursor: **`.cursor/rules/kintone-destructive-rest-guard.mdc`**。**計画**: 画像一括 `docs/plans/2026-05-06-681-bulk-image-upload.md`。 |
