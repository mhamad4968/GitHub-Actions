...
| **部署予実・入力**（明細・`新フォーマット` 全列・`支払内訳` サブテーブル・月次 12 行） | **677** | `customize/677/desktop.js` \| `npm run deploy:677` | [https://jbis-kintone.cybozu.com/k/677/](https://jbis-kintone.cybozu.com/k/677/)・**配置**: Space **54** / thread **58**。**2026-05-02**: customize deploy 済。**データ**: 旧フォーマット xlsx から **47 明細**投入（`npm run yojitsu:677:record-count`）。`SPEC.md` §6–§6c |
| **部署予実・ダッシュ**（**集計管理の主画面**・俯瞰・入力アプリ参照） | **678** | `customize/678/desktop.js` \| `npm run deploy:678` | [https://jbis-kintone.cybozu.com/k/678/](https://jbis-kintone.cybozu.com/k/678/)・**2026-05-02**: 677 表・備考列・ダッシュ備考（50 行目合計除外）・表示順 PUT / fileKey **`4fbc29b0-2612-4c8b-9c44-20df790f8949`** / rev **6** / **BUILD=`2026-05-02-678-dashboard-notes-column`**。`SPEC.md` §6b・§6e |
