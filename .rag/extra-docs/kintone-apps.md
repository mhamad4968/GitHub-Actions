...
| **部署予実・ダッシュ**（**集計管理の主画面**・俯瞰・入力アプリ参照） | **678** | `customize/678/desktop.js` \| `npm run deploy:678` | [https://jbis-kintone.cybozu.com/k/678/](https://jbis-kintone.cybozu.com/k/678/)・入力と同スペース。**2026-05-02**: 677 取得表＋**表示順 PUT** deploy **SUCCESS** / fileKey **`1111e294-e284-4d8b-888b-7b10b32c2da1`** / rev **5** / **BUILD=`2026-05-02-678-dashboard-display-order-put`**。`SPEC.md` §6b・§6e |
