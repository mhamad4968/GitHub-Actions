...
| 新・PC台帳ver.1（本体・674 customize **本実装進行中**・**運用開始前**） | **674** | `customize/new-pc-ledger-v1/desktop.js` | `npm run deploy:674` / Space **21** / thread **23** / customize **BUILD=`2026-05-05-pc-ledger-detail-two-buttons`**（閲覧=detail では **PC買替・印刷のみ**／新規・編集は従来どおり全ボタン・PC買替 §4.10.3 含む・**627 は二重更新しない**）/ fileKey **`43ddeb45-a61d-4951-9e5a-8be2bd828bc2`** / preview revision **`88`** / field-spec **44/44** / **運用開始予定 2026-05-13**（仕様書 §1） |
