...
|-----|---------------|----------|---------|------|
| 595 | `2026-08-13-595-index-pc-filter-ui` | **121** | `60328c29-ae33-436d-a24c-a24aedc97b6e` | 2026-08-13 形骸594サブテーブル参照除去・孤児ログ欄削除 |
...
| 社員マスタ（674/714/716 連携） | **595** | `customize/595/desktop.js` | **本番 live 最終 deploy（2026-08-13）**: `npm run deploy:595` → **BUILD=`2026-08-13-595-index-pc-filter-ui` rev **121** / fileKey **`60328c29-ae33-436d-a24c-a24aedc97b6e`** （削除済み594 `pc_ledger_list` 参照除去・退職時は `pc_ledger_v1_list` のみクリア）。一括反映ログは **697 `bulk_downstream_595_log`**（595 の形骸 `bulk_downstream_sync_log` は削除）。**前**: 2026-07-04 fileKey `e47d849c-…` rev **116** / `2026-07-04-595-index-emp-dept-filters` |
