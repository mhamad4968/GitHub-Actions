...
| 734 | `2026-08-16-dashboard-ux-polish` | **32** | `47bbc59a-9dbd-4e02-8a04-4e46c4e2deeb` | 2026-08-16 UX 1–6・8（toolbar/sticky/count/copy/pill/36px/list print） |
...
| **VPNアカウント台帳**（日常 UI・733 へ REST） | **734** | `customize/vpn-account-dash/desktop.js` \| `npm run deploy:734` | [https://jbis-kintone.cybozu.com/k/734/](https://jbis-kintone.cybozu.com/k/734/) **Space 48 / thread 52**・**v1.3 運用中** — 3ドメイン統合・595検索・PC台帳674連携・**VPN接続情報アコーディオン**（**VPNアカウント管理画面URL**・接続PW編集・**(yyyy/mm/dd更新)** 表示）・ライセンス集計・利用者印刷・**リスト出力（xlsx+印刷）** — 所属 **multi-select + 一括（全選択/全解除/本社/支店・営業所）**・ドメイン **すべて | 個別指定（複数可）**・UX **toolbar 3区分 / sticky / 件数 / コピー / ドメインピル / 36px / 一覧印刷機密1行**・**BUILD=`2026-08-16-dashboard-ux-polish` rev **32** / fileKey **`47bbc59a-9dbd-4e02-8a04-4e46c4e2deeb`**・月末リマインド **Space 48 注意書き**（JST **28日〜翌1日**のみ・`vpn-license-space48-notice` GHA） |
