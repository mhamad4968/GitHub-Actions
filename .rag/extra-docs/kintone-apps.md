...
|-----|---------------|----------|---------|------|
| 595 | `2026-08-13-595-sort-insert-list-ui` | **125** | `80f84a57-fdf5-4af4-bf42-b49bcea22a6c` | 2026-08-13 形骸594サブテーブル参照除去・孤児ログ欄削除 |
| 674 | `2026-08-18-674-m365-usage-default-available` | **336** | `dce4dd96-dbed-470c-9ae3-8d1d5e03badb` | 2026-07-09 リスト出力 列選択+Excel（bundle deploy） |
...
| 715 | `2026-08-15-715-list-dept-680-sync` | **24** | `c196e66a-51bb-4798-bde3-115cb6b13266` | 2026-08-15 リスト所属を整理後680（39件）に同期 |
...
| 社員マスタ（674/714/716 連携） | **595** | `customize/595/desktop.js` | **本番 live 最終 deploy（2026-08-13）**: `npm run deploy:595` → **BUILD=`2026-08-13-595-sort-insert-list-ui` rev **125** / fileKey **`80f84a57-fdf5-4af4-bf42-b49bcea22a6c`** （削除済み594 `pc_ledger_list` 参照除去・退職時は `pc_ledger_v1_list` のみクリア）。一括反映ログは **697 `bulk_downstream_595_log`**（595 の形骸 `bulk_downstream_sync_log` は削除）。**前**: 2026-07-04 fileKey `e47d849c-…` rev **116** / `2026-07-04-595-index-emp-dept-filters` |
...
| **ソフトウエア台帳DB**（ライセンス割当正本・閲覧のみ） | **714** | `customize/software-ledger-db/desktop.js` \| `npm run deploy:714` | [https://jbis-kintone.cybozu.com/k/714/](https://jbis-kintone.cybozu.com/k/714/) **Space 21 / thread 23**・**2026-06-14**: 18 フィールド・正本 `docs/plans/2026-06-13-software-ledger-kintone-spec.md`・**BUILD=`2026-06-14-software-ledger-db-block-ui-mutations`** rev **5** / fileKey **`45b4c125-5d47-47a1-a373-3bbcd273b54d`** |
| **ソフトウエア管理台帳ver.1**（日常 UI・714 へ REST） | **715** | `customize/software-ledger-dash/desktop.js` \| `npm run deploy:715` | [https://jbis-kintone.cybozu.com/k/715/](https://jbis-kintone.cybozu.com/k/715/) **Space 21 / thread 23**・**2026-08-15**: UI v1.1＋表示名バージョン・社員番号非表示・**BUILD=`2026-08-15-715-list-dept-680-sync` rev **24** / fileKey **`c196e66a-51bb-4798-bde3-115cb6b13266`** |
