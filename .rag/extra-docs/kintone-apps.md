...
| 770 | `2026-07-28-tokai-ipad-dash-v3-list-intro-date` | **13** | `440410f1-4e7c-403b-9d52-9f32cc8dc0c2` | 2026-07-28 東海支店iPad Dash v1（一覧・採番・印刷・Excel・同期） |
...
| **東海支店iPad管理台帳**（日常 UI・769 へ REST） | **770** | `customize/tokai-ipad-dash/desktop.js` \| `npm run deploy:770` | [https://jbis-kintone.cybozu.com/k/770/](https://jbis-kintone.cybozu.com/k/770/) **Space 32 / thread 34**・**BUILD=`2026-07-28-tokai-ipad-dash-v3-list-intro-date` rev **13** / fileKey **`440410f1-4e7c-403b-9d52-9f32cc8dc0c2`**・ACL=tokai+admin・Lookup なし・595/674 は admin 直／tokai は同期中継（`docs/runbooks/tokai-ipad-sync-relay.md`） |
