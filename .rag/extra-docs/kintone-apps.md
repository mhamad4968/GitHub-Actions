...
| 694 | `2026-08-11-694-print-no-mdm` | **21** | `c412b694-f200-49f7-9e2f-20acfeaa12e2` | 2026-06-08 端末交換日フィールド |
...
| **Apple ID管理台帳**（日常 UI・693 へ REST） | **694** | `customize/apple-id-dash/desktop.js` \| `npm run deploy:694` | [https://jbis-kintone.cybozu.com/k/694/](https://jbis-kintone.cybozu.com/k/694/) **Space 21 / thread 23**・**2026-06-06**: 編集で **Apple ID・PW・ロック** 修正可・**BUILD=`2026-08-11-694-print-no-mdm` rev **21** / fileKey **`c412b694-f200-49f7-9e2f-20acfeaa12e2`** |
