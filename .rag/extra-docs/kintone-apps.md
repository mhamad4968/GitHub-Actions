...
| 688 | `2026-06-13-688-ref5yr-zero-year-register` | **23** | `247fc365-3821-42e1-a7ec-57f14eb2416d` | 2026-06-13 見積作成年・過去5年CSV・全閾値表 |
...
| 721 | `2026-06-18-jr-ipad-dash-list-print-landscape` | **11** | `1505144a-b3e2-4868-854b-3a6b9478abf7` | 2026-06-18 一覧印刷 A4横向き・全12列 |
...
| 734 | `2026-06-16-vpn-account-dash-license-all-depts` | **12** | `273ed3ab-d253-4d6a-ab79-778b66c2bf66` | 2026-06-16 集計0件所属も全表示 |
...
| **JRシステム用iPad管理台帳 ver.1**（日常 UI・720 へ REST） | **721** | `customize/jr-ipad-dash/desktop.js` \| `npm run deploy:721` | [https://jbis-kintone.cybozu.com/k/721/](https://jbis-kintone.cybozu.com/k/721/) **Space 34 / thread 38**・**BUILD=`2026-06-18-jr-ipad-dash-list-print-landscape`** rev **11** |
...
| JRシステム用iPad管理台帳 ver.1 | **721** | `customize/jr-ipad-dash/desktop.js`（`desktop.src.js` + bundle） | `2026-06-18-jr-ipad-dash-list-print-landscape` rev11 | `deploy:721`（前に `jr-ipad:bundle-dash`） |

**721 主要機能**: 694 型一覧・admin のみ・2 系統採番（JBIS### + jb###m）・**集計表はアコーディオン（初期閉じ）**・端末別 A4 印刷・モデルコンボボックス + NFKC 正規化・**検索・絞込クリアボタン**。
