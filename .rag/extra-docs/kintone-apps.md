...
| 715 | `2026-08-19-715-install-target-pc` | **25** | `317faf6a-ce7f-40be-9910-d24e81a3acef` | 2026-08-19 v1.2 種別個人/共有・674 PC設置先 |
...
| **ソフトウエア管理台帳ver.1**（日常 UI・714 へ REST） | **715** | `customize/software-ledger-dash/desktop.js` \| `npm run deploy:715` | [https://jbis-kintone.cybozu.com/k/715/](https://jbis-kintone.cybozu.com/k/715/) **Space 21 / thread 23**・**2026-08-19 v1.2**: 種別個人/共有・674 PC 設置先・**BUILD=`2026-08-19-715-install-target-pc` rev **25** / fileKey **`317faf6a-ce7f-40be-9910-d24e81a3acef`** |
