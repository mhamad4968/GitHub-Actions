...
| 770 | `2026-07-28-tokai-ipad-dash-v3-summary-closed` | **9** | `25cd87f2-ac31-4352-afde-bf60b052fe59` | 2026-07-28 東海支店iPad Dash v1（一覧・採番・印刷・Excel・同期） |
...
| **東海支店iPad管理台帳**（日常 UI・769 へ REST） | **770** | `customize/tokai-ipad-dash/desktop.js` \| `npm run deploy:770` | [https://jbis-kintone.cybozu.com/k/770/](https://jbis-kintone.cybozu.com/k/770/) **Space 32 / thread 34**・**BUILD=`2026-07-28-tokai-ipad-dash-v3-summary-closed` rev **9** / fileKey **`25cd87f2-ac31-4352-afde-bf60b052fe59`**・ACL=tokai+admin・Lookup なし・595/674 は admin 直／tokai は同期中継（`docs/runbooks/tokai-ipad-sync-relay.md`） |
