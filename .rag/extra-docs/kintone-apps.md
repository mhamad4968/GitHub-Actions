...
| 756 | `2026-07-26-ver02-partial-block-render` | **142** | `6fd220a2-9af2-49f8-b7b1-e5032ae553c7` | Ver.02 App1 fail-closed read-only shell |
| 757 | `2026-07-21-ver02-phase6-app2-readonly-guard` | **23** | `8d1c53d9-aa77-4d94-95f6-d54d3ffaf86e` | Ver.02 App2 direct-write guard / fail-closed read-only shell |
| 758 | `2026-07-21-ver02-phase6-app3-readonly-guard` | **22** | `358eca86-37d3-47f6-9e86-c371c872cc09` | Ver.02 App3 direct-write guard / fail-closed read-only shell |
