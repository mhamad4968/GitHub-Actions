...
| 694 | `2026-08-16-694-ui-print-confidential` | **25** | `8740388e-fc57-487a-8bb4-386d5e032d9f` | 2026-06-08 端末交換日フィールド |
...
| **Apple ID管理台帳**（日常 UI・693 へ REST） | **694** | `customize/apple-id-dash/desktop.js` \| `npm run deploy:694` | [https://jbis-kintone.cybozu.com/k/694/](https://jbis-kintone.cybozu.com/k/694/) **Space 21 / thread 23**・**2026-06-06**: 編集で **Apple ID・PW・ロック** 修正可・**BUILD=`2026-08-16-694-ui-print-confidential` rev **25** / fileKey **`8740388e-fc57-487a-8bb4-386d5e032d9f`** |
