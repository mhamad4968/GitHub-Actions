...
| 674 | `2026-08-10-674-ui-hub-tabs-p2a` | **317** | `c29d5c22-e7eb-4993-9c81-55493bf31911` | 2026-07-09 リスト出力 列選択+Excel（bundle deploy） |
...
| 694 | `2026-08-11-694-print-device-date-label` | **22** | `de30d28a-46bb-4464-baf7-3e3d443cf0f9` | 2026-06-08 端末交換日フィールド |
...
| **Apple ID管理台帳**（日常 UI・693 へ REST） | **694** | `customize/apple-id-dash/desktop.js` \| `npm run deploy:694` | [https://jbis-kintone.cybozu.com/k/694/](https://jbis-kintone.cybozu.com/k/694/) **Space 21 / thread 23**・**2026-06-06**: 編集で **Apple ID・PW・ロック** 修正可・**BUILD=`2026-08-11-694-print-device-date-label` rev **22** / fileKey **`de30d28a-46bb-4464-baf7-3e3d443cf0f9`** |
