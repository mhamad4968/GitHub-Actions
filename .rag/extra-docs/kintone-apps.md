...
| 715 | `2026-08-15-715-ui-readability-v11` | **14** | `5b4c8636-af68-4071-8d79-93cb427d8c24` | 2026-08-15 UI v1.1 一覧可読性・モーダル区画・一覧印刷 |
...
| **ソフトウエア管理台帳ver.1**（日常 UI・714 へ REST） | **715** | `customize/software-ledger-dash/desktop.js` \| `npm run deploy:715` | [https://jbis-kintone.cybozu.com/k/715/](https://jbis-kintone.cybozu.com/k/715/) **Space 21 / thread 23**・**2026-08-15**: UI v1.1（一覧9列・モーダル区画・一覧を印刷）・**BUILD=`2026-08-15-715-ui-readability-v11` rev **14** / fileKey **`5b4c8636-af68-4071-8d79-93cb427d8c24`** |
