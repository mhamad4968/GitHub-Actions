...
| 756 | `2026-07-26-ver02-vendor-ij-merge` | **147** | `bc91525b-b648-4921-aee6-628588fdaecf` | Ver.02 App1 fail-closed read-only shell |
| 757 | `2026-07-21-ver02-phase6-app2-readonly-guard` | **28** | `9548c854-5c8e-4692-92a4-e6eaa2c0d318` | Ver.02 App2 direct-write guard / fail-closed read-only shell |
| 758 | `2026-07-21-ver02-phase6-app3-readonly-guard` | **27** | `a6c919a2-0b44-4fb5-b4ce-b77c60db46bd` | Ver.02 App3 direct-write guard / fail-closed read-only shell |
