...
| 715 | `2026-06-17-software-ledger-user-filter-compact` | **13** | `995b8658-e960-4d39-81de-ca1f61a4fa44` | 2026-06-17 利用者チップを社員検索絞り込みに変更 |
...
| **ソフトウエア管理台帳ver.1**（日常 UI・714 へ REST） | **715** | `customize/software-ledger-dash/desktop.js` \| `npm run deploy:715` | [https://jbis-kintone.cybozu.com/k/715/](https://jbis-kintone.cybozu.com/k/715/) **Space 21 / thread 23**・**2026-06-17**: 利用者チップを社員検索絞り込みに変更・**BUILD=`2026-06-17-software-ledger-user-filter-compact` rev **13** / fileKey **`995b8658-e960-4d39-81de-ca1f61a4fa44`** |
