...
|-----|---------------|----------|---------|------|
| 595 | `2026-08-19-595-skip-715-shared-install` | **127** | `a66e603d-e671-4e0c-93a7-12d7b7fa8c0c` | 2026-08-19 715共有設置先は社員ミラー対象外 |
...
| 715 | `2026-08-19-715-pc-lookup-mail-subtable` | **26** | `daa9553e-bd9b-4429-b568-33b9c09985b8` | 2026-08-19 個人PC照合 mail+595紐づけ |
...
| 社員マスタ（674/714/716 連携） | **595** | `customize/595/desktop.js` | **本番 live 最終 deploy（2026-08-13）**: `npm run deploy:595` → **BUILD=`2026-08-19-595-skip-715-shared-install` rev **127** / fileKey **`a66e603d-e671-4e0c-93a7-12d7b7fa8c0c`** （削除済み594 `pc_ledger_list` 参照除去・退職時は `pc_ledger_v1_list` のみクリア）。一括反映ログは **697 `bulk_downstream_595_log`**（595 の形骸 `bulk_downstream_sync_log` は削除）。**前**: 2026-07-04 fileKey `e47d849c-…` rev **116** / `2026-07-04-595-index-emp-dept-filters` |
...
| **ソフトウエア管理台帳ver.1**（日常 UI・714 へ REST） | **715** | `customize/software-ledger-dash/desktop.js` \| `npm run deploy:715` | [https://jbis-kintone.cybozu.com/k/715/](https://jbis-kintone.cybozu.com/k/715/) **Space 21 / thread 23**・**2026-08-19 v1.2**: 種別個人/共有・674 PC 設置先・**BUILD=`2026-08-19-715-pc-lookup-mail-subtable` rev **26** / fileKey **`daa9553e-bd9b-4429-b568-33b9c09985b8`** |
