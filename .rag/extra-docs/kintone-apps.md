...
| 756 | `2026-07-21-ver02-phasec2b-save-02` | **24** | `eb1d5cd8-92ed-4d28-afc4-7018e62710f9` | Ver.02 App1 fail-closed read-only shell |
| 757 | `2026-07-21-ver02-phase6-app2-readonly-guard` | **9** | `62efd690-efa5-4a79-b769-9219af3f8f16` | Ver.02 App2 direct-write guard / fail-closed read-only shell |
| 758 | `2026-07-21-ver02-phase6-app3-readonly-guard` | **9** | `4766245e-c46d-432b-bf0a-aae189ffd183` | Ver.02 App3 direct-write guard / fail-closed read-only shell |
