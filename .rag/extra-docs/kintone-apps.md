...
| 682 | `2026-08-23-682-quick-create-a6` | **29** | `8e583565-f4e6-4c1f-ad96-c5d9e75b627a` | 2026-05-16 registry 整合 |
| 683 | `2026-08-23-683-special-weekend-ux` | **113** | `bf7a3671-48e3-4bfe-ac0f-3757d52d4eb3` | 2026-05-16 registry 整合 |
...
**721 主要機能**: 694 型一覧・admin のみ・2 系統採番・既存登録・集計アコーディオン（**セルクリック絞込 P2-1**）・端末 A4・一覧印刷（該当件数）・検索クリア・有効/廃止・いまの条件＋該当件数・ステータスチップ色分け・一覧 Excel（PW 含む）・端末名/Apple ID コピー・部署区切り・絞込 2 段。

**状態（2026-08-23）**: **P0/P1＋P2-1+A+B+V1–7 目視 OK — CLOSED**（`docs/plans/2026-08-23-jr-ipad-721-p2-vux-spec.md`）。P2-2 / C〜I / 694・674 連携は見送り。
