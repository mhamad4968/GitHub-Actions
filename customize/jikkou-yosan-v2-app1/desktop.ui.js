  ...
  // @JY_V2_BUILD 2026-08-02-ver02-actual-tab-font
  ...
  function jy2InstallStyle(documentRef) {
    ...
    style.textContent = [
      ...
      ".jy2-actual-himoku-fold-btn{flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;padding:0;margin:0;border:1px solid #86efac;border-radius:4px;background:#fff;color:#166534;font-size:10px;line-height:1;cursor:pointer;box-shadow:0 1px 0 rgba(22,101,52,.06)}",
