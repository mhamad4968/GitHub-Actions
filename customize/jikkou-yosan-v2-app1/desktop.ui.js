  ...
  // @JY_V2_BUILD 2026-08-01-ver02-actual-excel-sonota-himoku
  // Phase2c-excel-sonota-himoku: 浜田訂正 — Excel原価管理明細では「その他材料費」は
  // 費目。種別なし・詳細2行（例: 塗装表示記録･数字シール）。表示し、手動のみでも出す。
