  ...
  // @JY_V2_BUILD 2026-08-02-ver02-actual-sticky-totals-month
  ...
  function jy2InstallStyle(documentRef) {
    ...
    style.textContent = [
      ...
      ".jy2-actual-totals-bar{position:sticky;top:0;z-index:45;display:flex;flex-direction:column;gap:8px;margin:8px 0 10px;padding:10px 12px;background:#fffbeb;border:1px solid #f59e0b;border-radius:8px;box-shadow:0 2px 8px rgba(15,23,42,.08);box-sizing:border-box}",
      ".jy2-actual-totals-bar .jy2-actual-totals-top{display:flex;flex-wrap:wrap;align-items:baseline;gap:10px 22px}",
  ...
  // Phase2c-actual-sticky-totals-month: 実行予算は全合計、月次は月単位の数量・金額。
  function jy2ActualCostMgmtStickyTotalsBar(documentRef, opts) {
    ...
    noteEl.textContent =
      "仮置き（給与手当除く・月次は月ごと。表の施工計+保安計と同趣旨）";
