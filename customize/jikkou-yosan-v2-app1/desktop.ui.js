  ...
  function jy2InstallStyle(documentRef) {
    ...
    style.textContent = [
      ...
      ".jy2-sticky-sheet-banner{display:flex;justify-content:center;align-items:center;width:100%;margin:6px 0 0;padding:0 8px 6px;box-sizing:border-box}",
      ".jy2-pane-head-banner{display:none}",
      ".jy2-sheet-title{width:auto;max-width:min(960px,100%);box-sizing:border-box;padding:10px 36px;border-radius:10px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;line-height:1.3;text-align:center;box-shadow:0 2px 6px rgba(15,23,42,.1);margin:0 auto}",
      ...
      // letter-spacing の末尾空きで左寄りに見えるため、margin で相殺して視覚中央へ
      ".jy2-sheet-title-doc{display:inline-block;font-size:20px;font-weight:800;letter-spacing:.2em;margin-inline-end:-.2em;padding:0;color:#1e3a8a;text-align:center}",
      ...
      ".jy2-sheet-title-sheet{display:inline-block;font-size:15px;font-weight:700;letter-spacing:.2em;margin-inline-end:-.2em;padding:4px 18px;border-radius:8px;background:#fff;text-align:center}",
      ...
      "@media (max-width:900px){.jy2-sheet-title{padding:8px 20px}.jy2-sheet-title-doc{font-size:17px;letter-spacing:.14em;margin-inline-end:-.14em}.jy2-sheet-title-sheet{font-size:13px;letter-spacing:.14em;margin-inline-end:-.14em;padding:3px 12px}}",
