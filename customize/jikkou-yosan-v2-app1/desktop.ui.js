  ...
  // @JY_V2_BUILD 2026-08-02-ver02-actual-howto-fold
  ...
  function jy2InstallStyle(documentRef) {
    ...
    style.textContent = [
      ...
      ".jy2-actual-totals-bar{position:sticky;top:0;z-index:45;margin:8px 0 10px;padding:0;background:#fffbeb;border:1px solid #f59e0b;border-radius:8px;box-shadow:0 2px 8px rgba(15,23,42,.08);box-sizing:border-box}",
      ".jy2-actual-totals-bar>summary{cursor:pointer;list-style:none;padding:10px 12px;font-size:13px;font-weight:700;color:#92400e;user-select:none}",
      ...
      ".jy2-actual-totals-bar>summary .jy2-actual-totals-summary-budget{font-weight:700;color:#1c1917;margin-left:6px;font-variant-numeric:tabular-nums}",
      ".jy2-actual-totals-bar>summary .jy2-actual-totals-summary-hint{font-weight:600;color:#a16207;margin-left:8px;font-size:12px}",
      ...
      ".jy2-actual-table th.jy2-actual-col-unit-price,.jy2-actual-table td.jy2-actual-col-unit-price,.jy2-actual-table .jy2-actual-group-unit-price{min-width:6.5rem;width:6.5rem;max-width:8.5rem;padding:2px 4px!important;box-sizing:border-box;white-space:nowrap}",
      ...
      ".jy2-actual-table .jy2-actual-child-unit-price-input{display:block;width:100%;min-width:5.5rem;box-sizing:border-box;text-align:right}",
      ...
      /* #R-EXCEL-UI-16: すべて展開／閉じる */
      ".jy2-actual-himoku-fold-toolbar{display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin:0 0 8px;padding:0 2px}",
      ".jy2-actual-himoku-fold-toolbar-label{font-size:12px;font-weight:600;color:#475569;margin-right:2px}",
      ".jy2-actual-himoku-fold-all-btn{padding:4px 10px;font-size:12px;font-weight:600;line-height:1.3;border:1px solid #64748b;border-radius:4px;background:#fff;color:#0f172a;cursor:pointer}",
      ".jy2-actual-himoku-fold-all-btn:hover{background:#e2e8f0}",
      ...
      ".jy2-actual-table .jy2-actual-type-group-label{padding-left:18px;font-weight:600;text-align:left;vertical-align:middle}",
      /* #R-EXCEL-UI-08: 数量・金額・合計は右揃え（親/費目/種別/詳細で共通） */
      ".jy2-actual-table td.jy2-actual-sum-cell,.jy2-actual-table td.jy2-actual-group-plan-qty,.jy2-actual-table td.jy2-actual-auto-budget{text-align:right;font-variant-numeric:tabular-nums}",
      ".jy2-actual-table .jy2-actual-parent-row td.jy2-num,.jy2-actual-table .jy2-actual-parent-row td.jy2-amount,.jy2-actual-table .jy2-actual-himoku-group-row td.jy2-num,.jy2-actual-table .jy2-actual-himoku-group-row td.jy2-amount,.jy2-actual-table .jy2-actual-type-group-row td.jy2-num,.jy2-actual-table .jy2-actual-type-group-row td.jy2-amount{text-align:right;font-variant-numeric:tabular-nums}",
      ".jy2-actual-table .jy2-actual-child-row td.jy2-actual-child-name,.jy2-actual-table .jy2-actual-dual-detail-left,.jy2-actual-table .jy2-actual-dual-detail-right{text-align:left}",
  ...
  function jy2RenderActualPane(
    ...
    noteBody.textContent =
      "Excel 原価管理明細と同じ列構成（システム工種｜費目｜種別｜詳細｜操作｜単価｜実行予算額｜月次数量/金額｜原価累計金額｜予算との差｜備考）。" +
      "費目は既定クローズ。詳細がある費目は▶／▼で開閉（閉じると費目名と数量・実行予算の合計のみ）。表上の「すべて展開／すべて閉じる」でも一括操作できる。" +
