  ...
  function jy2InstallStyle(documentRef) {
    ...
    style.textContent = [
      ...
      ".jy2-pane{display:none;min-height:200px;padding:10px 12px 14px;background:#fff;border:1px solid #cbd5e1;border-top:none;border-radius:0 0 8px 8px}",
      ...
      ".jy2-pane[data-tab-id='actual']{overflow:visible;padding:8px}",
      ".jy2-actual-scroll{overflow:auto;border:1px solid #e2e8f0;border-radius:6px;background:#fff;max-width:100%;width:100%;max-height:min(70vh,720px);-webkit-overflow-scrolling:touch}",
      ".jy2-actual-table{white-space:nowrap;margin:0;border-collapse:separate;border-spacing:0;font-size:11px}",
      ...
      ".jy2-actual-table thead .jy2-freeze{z-index:6;background:#f1f5f9}",
      ...
      "#jy2-host{margin:0 0 12px;padding:0;overflow-x:hidden;overflow-y:visible;max-width:100%;width:100%;box-sizing:border-box}",
  ...
  function jy2HideNativeDetailChrome(documentRef) {
    ...
    style.textContent = [
      ...
      ".gaia-argoui-app-show-contents{margin:0!important;padding-top:0!important;width:100%!important;max-width:100%!important;overflow-x:hidden!important;box-sizing:border-box!important}",
      ".contents-gaia{margin:0!important;padding-top:0!important;max-width:100%!important;overflow-x:hidden!important;box-sizing:border-box!important}",
      ".record-detail-gaia,.record-edit-gaia,.record-create-gaia{margin-top:0!important;padding-top:0!important}",
      "body.jy2-detail-shell{overflow-x:hidden!important}",
      "body.jy2-detail-shell .container-gaia{max-width:100%!important;overflow-x:hidden!important;padding-top:0!important}",
      "body.jy2-detail-shell #jy2-host{margin-top:0!important;padding-top:0!important}",
    ].join("");
