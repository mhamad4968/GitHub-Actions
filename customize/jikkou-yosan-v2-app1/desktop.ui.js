  ...
  function jy2InstallStyle(documentRef) {
    ...
    style.textContent = [
      ...
      ".jy2-shell{font-family:'Segoe UI',Meiryo,sans-serif;background:#f8fafc;border:1px solid #cbd5e1;border-radius:8px;color:#334155;overflow-x:hidden;overflow-y:visible;padding:0 0 12px;max-width:100%;width:100%;box-sizing:border-box}",
      ...
      ".jy2-pane{display:none;min-height:240px;padding:14px 16px 18px;background:#fff;border:1px solid #cbd5e1;border-top:none;border-radius:0 0 8px 8px}",
      ".jy2-pane[data-active='true']{display:block}",
      ".jy2-pane[data-tab-id='header'][data-active='true']{border-color:#94a3b8;border-top:3px solid #64748b;background:linear-gradient(180deg,#f8fafc 0%,#fff 48px)}",
      ".jy2-pane[data-tab-id='summary'][data-active='true']{border-color:#93c5fd;border-top:3px solid #3b82f6;background:linear-gradient(180deg,#f8fafc 0%,#eff6ff 100%)}",
      ".jy2-pane[data-tab-id='detail'][data-active='true']{border-color:#86efac;border-top:3px solid #22c55e;background:linear-gradient(180deg,#f8fafc 0%,#ecfdf5 100%)}",
      ".jy2-pane[data-tab-id='actual'][data-active='true']{border-color:#fcd34d;border-top:3px solid #f59e0b;background:linear-gradient(180deg,#f8fafc 0%,#fffbeb 100%)}",
      ".jy2-pane[data-tab-id='version'][data-active='true']{border-color:#c4b5fd;border-top:3px solid #7c3aed;background:linear-gradient(180deg,#f8fafc 0%,#f5f3ff 100%)}",
      ".jy2-pane-head-banner{display:flex;justify-content:center;width:100%;margin:4px 0 14px}",
      ".jy2-sheet-title{width:100%;max-width:960px;box-sizing:border-box;padding:16px 40px;border-radius:10px;display:flex;flex-direction:column;align-items:center;gap:8px;text-align:center}",
      ".jy2-sheet-title-header{background:linear-gradient(135deg,#f8fafc 0%,#e2e8f0 55%,#cbd5e1 100%);border:1px solid #94a3b8;box-shadow:0 3px 8px rgba(71,85,105,.14)}",
      ".jy2-sheet-title-summary{background:linear-gradient(135deg,#eff6ff 0%,#dbeafe 55%,#bfdbfe 100%);border:1px solid #93c5fd;box-shadow:0 3px 8px rgba(37,99,235,.16)}",
      ".jy2-sheet-title-detail{background:linear-gradient(135deg,#ecfdf5 0%,#d1fae5 55%,#bbf7d0 100%);border:1px solid #86efac;box-shadow:0 3px 8px rgba(5,150,105,.16)}",
      ".jy2-sheet-title-actual{background:linear-gradient(135deg,#fffbeb 0%,#fef3c7 55%,#fde68a 100%);border:1px solid #fcd34d;box-shadow:0 3px 8px rgba(245,158,11,.16)}",
      ".jy2-sheet-title-version{background:linear-gradient(135deg,#f5f3ff 0%,#ede9fe 55%,#ddd6fe 100%);border:1px solid #c4b5fd;box-shadow:0 3px 8px rgba(124,58,237,.14)}",
      ".jy2-sheet-title-doc{font-size:22px;font-weight:800;letter-spacing:.22em;color:#1e3a8a;line-height:1.3}",
      ...
      ".jy2-sheet-title-sheet{font-size:17px;font-weight:700;letter-spacing:.28em;padding:5px 22px;border-radius:8px;display:inline-block;background:#fff}",
      ...
      // 予実: 横スクロールは表ラッパ1本のみ（親との二重スクロール防止）
      ".jy2-pane[data-tab-id='actual']{overflow:visible;padding:10px 8px 14px}",
      ".jy2-pane[data-tab-id='actual'] .jy2-pane-head-banner{margin:0 0 8px}",
      ".jy2-pane[data-tab-id='actual'] .jy2-sheet-title{padding:10px 18px;gap:4px}",
      ".jy2-pane[data-tab-id='actual'] .jy2-sheet-title-doc{font-size:16px;letter-spacing:.12em}",
      ".jy2-pane[data-tab-id='actual'] .jy2-sheet-title-sheet{font-size:14px;letter-spacing:.14em;padding:3px 14px}",
      ".jy2-actual-scroll{overflow-x:auto;overflow-y:visible;border:1px solid #e2e8f0;border-radius:6px;background:#fff;max-width:100%;width:100%;-webkit-overflow-scrolling:touch}",
      ".jy2-actual-table{white-space:nowrap;margin:0}",
      ".jy2-actual-table .jy2-input{min-width:72px}",
      ".jy2-actual-note{color:#64748b;font-size:11px;margin:2px 0 8px}",
      ".jy2-actual-table thead th{text-align:center;vertical-align:middle}",
      ".jy2-actual-table thead th[colspan]{background:#fef3c7}",
      ".jy2-actual-table thead tr:last-child th{background:#f1f5f9;font-size:11px}",
      ...
      ".jy2-save-button{border:1px solid #2563eb;background:#2563eb;color:#fff;padding:8px 18px;font-weight:700;cursor:pointer;border-radius:6px}",
      ".jy2-save-button[disabled]{opacity:.5;cursor:not-allowed}",
      ".jy2-sticky-top{position:sticky;top:48px;z-index:1000;background:#fff;border-bottom:1px solid #e2e8f0;padding:6px 8px 0;margin:0;box-shadow:0 2px 8px rgba(15,23,42,.06);max-width:100%;box-sizing:border-box;overflow:visible}",
      ".jy2-sticky-top .jy2-header{display:none}",
      // 保存等は常に左端（狭い窓でも最初に見える）
      ".jy2-action-bar{display:flex;flex-wrap:nowrap;gap:6px 8px;align-items:center;justify-content:flex-start;margin-bottom:2px;width:100%;box-sizing:border-box;overflow-x:auto;overflow-y:hidden;-webkit-overflow-scrolling:touch}",
      ...
      ".jy2-btn-primary{border-color:#2563eb;background:#2563eb;color:#fff}",
      ...
      ".jy2-sticky-top .jy2-tabs{margin:6px 0 0;padding:0;background:transparent}",
  ...
  function jy2HideNativeDetailChrome(documentRef) {
    ...
    style.textContent = [
      ...
      ".gaia-argoui-app-show-contents{margin-right:0!important;width:100%!important;max-width:100%!important;overflow-x:hidden!important;box-sizing:border-box!important}",
      ".contents-gaia{margin-right:0!important;max-width:100%!important;overflow-x:hidden!important;box-sizing:border-box!important}",
      "body.jy2-detail-shell{overflow-x:hidden!important}",
      "body.jy2-detail-shell .container-gaia{max-width:100%!important;overflow-x:hidden!important}",
    ].join("");
  ...
  function jy2PaneBanner(documentRef, tabId, sheetLabel) {
    ...
    const doc = documentRef.createElement("div");
    doc.className = "jy2-sheet-title-doc";
    doc.textContent = "実　行　予　算　書";
  ...
  function jy2RenderHeaderPane(documentRef, record, editable, masterLists) {
    const wrap = documentRef.createElement("div");
    wrap.appendChild(jy2PaneBanner(documentRef, "header", "工事基本情報"));
  ...
  function jy2RenderSummaryPane(
    ...
    pane.textContent = "";
    pane.appendChild(jy2PaneBanner(documentRef, "summary", "総括表"));
  ...
  function jy2RenderDetailPane(documentRef, pane, detailModel, refreshSummary, masterLists) {
    pane.textContent = "";
    pane.appendChild(jy2PaneBanner(documentRef, "detail", "内訳"));
  ...
  function jy2RenderActualPane(
    ...
    pane.textContent = "";
    pane.appendChild(jy2PaneBanner(documentRef, "actual", "予実管理"));
  ...
  function jy2RenderVersionPane(
    ...
    pane.textContent = "";
    pane.appendChild(jy2PaneBanner(documentRef, "version", "バージョン管理"));
    pane.appendChild(
      jy2Cell(
        documentRef,
        "h3",
