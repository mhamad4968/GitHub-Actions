  ...
  // @JY_V2_BUILD 2026-07-25-ver02-actual-right-6px
  ...
  function jy2InstallStyle(documentRef) {
    ...
    style.textContent = [
      ...
      /* 右息抜き ~6px（0は窮屈・10はやや広い） */
      ".jy2-actual-scroll{display:block;overflow-x:auto;overflow-y:visible;border:1px solid #e2e8f0;border-radius:6px;background:#fff;max-width:100%;width:100%;min-width:0;max-height:none;box-sizing:border-box;padding:0 6px 6px 0;margin:0;-webkit-overflow-scrolling:touch;overscroll-behavior-x:contain}",
  ...
  function jy2SyncHScroll(scrollEl) {
    ...
    // 予実は右息抜き6px。一般表は罫線確保のため16
    const gutter = scrollEl.classList.contains("jy2-actual-scroll") ? 6 : 16;
