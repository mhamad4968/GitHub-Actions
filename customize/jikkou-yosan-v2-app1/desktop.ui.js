  ...
  function jy2InstallStyle(documentRef) {
    ...
    style.textContent = [
      // A-07 / 736テイスト: slate chrome・色分けタブ・シート見出し・薄茶合計
      ".jy2-shell{font-family:'Segoe UI',Meiryo,sans-serif;background:#f8fafc;border:1px solid #cbd5e1;border-radius:8px;color:#334155;overflow:visible;padding:0 0 12px}",
      ".jy2-header{display:flex;justify-content:center;align-items:center;padding:14px 16px;margin:0 0 8px;background:linear-gradient(135deg,#f8fafc 0%,#e2e8f0 55%,#cbd5e1 100%);border:1px solid #94a3b8;border-radius:10px;box-shadow:0 3px 8px rgba(71,85,105,.14);color:#334155;flex-direction:column;gap:4px}",
      ...
      ".jy2-tabs{display:flex;gap:4px;padding:8px 4px 0;background:transparent;flex-wrap:wrap}",
      ".jy2-tab{border:1px solid #cbd5e1;border-bottom:0;border-radius:6px 6px 0 0;background:#f1f5f9;padding:9px 16px;cursor:pointer;font-size:13px;font-weight:600;color:#475569}",
      ...
      ".jy2-sticky-top{position:sticky;top:48px;z-index:1000;background:#fff;border-bottom:1px solid #e2e8f0;padding:8px 12px 0;margin:0;box-shadow:0 2px 8px rgba(15,23,42,.06)}",
      ".jy2-sticky-top .jy2-header{margin:0 0 8px}",
      ".jy2-action-bar{display:flex;flex-wrap:wrap;gap:8px 12px;align-items:center;justify-content:space-between;margin-bottom:4px}",
      ...
      ".jy2-btn{border:1px solid #94a3b8;background:#f8fafc;color:#0f172a;padding:8px 16px;font-size:13px;font-weight:600;cursor:pointer;border-radius:6px}",
      ...
      ".jy2-lock-banner{margin:0 0 8px;padding:8px 12px;background:#fff3cd;border:1px solid #ffc107;color:#92400e;font-size:12px;font-weight:700;border-radius:6px}",
  ...
  function jy2RenderShell(container, record, data) {
    ...
    title.textContent = "実　行　予　算　書";
    const stub = documentRef.createElement("span");
    stub.className = "jy2-header-stub";
    stub.textContent = `ver02 · BUILD ${BUILD} / ${model.lockState}`;
