...
| `.cursor/rules/creation-timing-ask.mdc` | **alwaysApply** — **作成着手前**に浜田へ **「今すぐ作成／後日」** を §41 一問で確認（浜田指示 2026-04-28） |
