...
| §50-3 | **CTO運用規定**（外部推理 MCP・コスト最適化 / **新規タスク 1ターン目**にパイプライン可視化 / プランB閾値 1,000トークン超・複数ファイル大規模 / 安価MCP **最大3回または累計5分**で Opus 切替 / MCP 送信の一方向サニタイズ / 「憲法適合済み」は検収コマンド併記義務 / 第14章・2026-04-28）|
...
| §50-3 | **CTO運用規定**（プランB閾値 / パイプライン可視化 / 安価MCPループ上限 / MCP送信サニタイズ / 憲法検収の証跡 / 2026-04-28）|
